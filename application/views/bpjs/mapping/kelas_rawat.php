<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-bed"></i> Referensi Kelas Rawat
            <small>Kelas Perawatan BPJS</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('admin/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Bridging BPJS</a></li>
            <li><a href="<?= base_url('bpjs/mapping'); ?>">Mapping BPJS</a></li>
            <li class="active">Kelas Rawat</li>
        </ol>
    </section>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-list"></i> Daftar Kelas Rawat</h3>
                    </div>
                            ...
                            <tbody>
                                <?php if (!empty($list_data) && is_array($list_data)): ?>
                                    <?php foreach ($list_data as $item): ?>
                                        <tr>
                                            <td align="center"><span class="badge bg-orange"><?= $item['kode']; ?></span></td>
