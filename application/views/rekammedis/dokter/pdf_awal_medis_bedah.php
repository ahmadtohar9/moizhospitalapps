...
<head>
    <title>Asesmen Awal Medis Bedah</title>
    <style>
        body {
...
<body>
    ...
    <h3 style="text-align:center; margin:0 0 20px 0; text-decoration:underline;">ASESMEN AWAL MEDIS BEDAH</h3>
            ...
            <tr>
                ...
                <td width="50%">
                    <ul>
                        ...
                        <li><b>Columna Vertebralis:</b> <?= $asesment['columna'] ?></li>
    ...
    <div class="section-title">IV. STATUS LOKALIS</div>
