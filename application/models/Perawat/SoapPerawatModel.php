...
class SoapPerawatModel extends CI_Model {
    ...
    /**
     * Simpan entri SOAP baru dengan field lengkap
     */
    public function save(array $data)
    {
        ...
        if ($exists) {
            log_message('debug', 'Skip insert: duplikat key SOAP Perawat (idempotent).');
    ...
    /**
     * Update dengan key komposit - handle semua field SOAP lengkap
     */
    ...
    public function deleteByNoRawatAndTime($no_rawat, $tgl_perawatan, $jam_rawat, $nip=null, $enforce48h=true)
    {
        ...
        // Load helper untuk pengecekan 48 jam
        $this->load->helper('empatdelapanjam');

        // Ambil record target untuk pengecekan owner dan waktu
        ...
        // Guard pemilik data
        if ($nip && isset($row['nip']) && $row['nip'] !== $nip) {
            log_message('error','Delete ditolak: bukan pemilik data');
            return false;
        }
    ...
    /**
     * DAPATKAN SEMUA SOAP per no_rawat dengan field lengkap
     */
    ...
    /**
     * Riwayat lintas kunjungan (per no_rkm_medis) dengan field lengkap
     */
    ...
    /**
     * Ambil entri TTV terakhir untuk auto-fill
     */
    ...
    /**
     * Ambil entri terakhir per no_rawat dengan field lengkap
     */
    ...
    /**
     * Ambil detail lengkap SOAP berdasarkan key dengan field lengkap
     */
