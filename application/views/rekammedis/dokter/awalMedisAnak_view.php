...
<div class="container-fluid">
    <form id="formAnakAssessment" autocomplete="off">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="canvas-wrapper" style="height:450px;">
                        ...
                        <canvas id="anakCanvas" width="600" height="350"></canvas>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="ket_lokalis" rows="18"
                        placeholder="Keterangan detail lokasi anak yang diperiksa..."></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <textarea class="form-control" name="penunjang" rows="3" placeholder="Lab, radiologi, EKG, dll..."
                <></textarea>
        </div>
...
<div class="container-fluid" style="margin-top:30px;">
    <div class="section-header" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);"><i
            class="fa fa-history"></i> RIWAYAT ASESMEN ANAK</div>
        ...
        fetch('<?= base_url("AwalMedisAnakController/get_detail") ?>?no_rawat=' + noRawat)
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    typeof Swal !== "undefined" && Swal.fire({
                        title: '<span style="color:#ec4899;"><i class="fa fa-file-medical"></i> Detail Asesmen Anak</span>',
                        html: html,
                        width: '900px',
