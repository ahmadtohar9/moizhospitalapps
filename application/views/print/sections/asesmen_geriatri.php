...
<div class="print-section">
    ...
    <?php if (!empty($d->geriatri->anamnesis)): ?>
    <div style="margin: 10px 0;">
        <strong>Anamnesis:</strong><br>
        <?= nl2br($d->geriatri->anamnesis) ?>
    </div>
    <?php endif; ?>
    
    <?php if (!empty($d->geriatri->pemeriksaan_fisik)): ?>
    <div style="margin: 10px 0;">
        <strong>Pemeriksaan Fisik:</strong><br>
        <?= nl2br($d->geriatri->pemeriksaan_fisik) ?>
    </div>
    <?php endif; ?>
    
    <?php if (!empty($d->geriatri->pemeriksaan_penunjang)): ?>
    <div style="margin: 10px 0;">
        <strong>Pemeriksaan Penunjang:</strong><br>
        <?= nl2br($d->geriatri->pemeriksaan_penunjang) ?>
    </div>
    <?php endif; ?>
    
    <?php if (!empty($d->geriatri->diagnosis)): ?>
    <div style="margin: 10px 0;">
        <strong>Diagnosis:</strong><br>
        <?= nl2br($d->geriatri->diagnosis) ?>
    </div>
    <?php endif; ?>
    
    <?php if (!empty($d->geriatri->tatalaksana)): ?>
    <div style="margin: 10px 0;">
        <strong>Tatalaksana:</strong><br>
        <?= nl2br($d->geriatri->tatalaksana) ?>
    </div>
    <?php endif; ?>
    ...
    <div style="margin: 15px 0;">
        ...
        <img src="<?= base_url('assets/images/lokalis_geriatri/lokalis_' . $clean_no_rawat . '.png') ?>" 
