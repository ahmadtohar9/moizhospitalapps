...
class RekamMedisRalanController extends CI_Controller
{
    ...
    public function loadForm($menu_url)
    {
        ...
        $form_map = [
            ...
            'AwalMedisKulitDanKelaminController/index' => ['model' => 'AwalMedisKulitKelaminModel', 'view' => 'rekammedis/dokter/awalMedisKulitKelamin_view'],
        ...
        if (isset($form_map[$decodedUrl])) {
            ...
            $new_modules = [
                ...
                'AwalMedisKulitDanKelaminController/index' => 'AwalMedisKulitKelaminModel',
