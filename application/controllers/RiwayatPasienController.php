...
class RiwayatPasienController extends CI_Controller
{
    ...
    public function detail_asesmen_gawat_darurat_psikiatri()
    {
        $this->_get_detail('get_asesmen_gawat_darurat_psikiatri_by_norawat');
    }

    public function detail_asesmen_geriatri()
    {
        $this->_get_detail('get_asesmen_geriatri_by_norawat');
    }

    public function detail_asesmen_rehab_medik()
    {
        $this->_get_detail('get_asesmen_medis_rehab_by_norawat');
    }

    public function detail_asesmen_urologi()
    {
        $this->_get_detail('get_asesmen_urologi_by_norawat');
    }
    ...
    public function detail_penilaian_medis_kandungan()
    {
    ...
    public function get_detail()
    {
        ...
        try {
            ...
            $data = [
                ...
                'kulitdankelamin' => $this->RiwayatPasien_model->get_penilaian_medis_kulitdankelamin_by_norawat($no_rawat),
                'neurologi' => $this->RiwayatPasien_model->get_penilaian_medis_neurologi_by_norawat($no_rawat),
                'paru' => $this->RiwayatPasien_model->get_penilaian_medis_paru_by_norawat($no_rawat),
                'psikiatrik' => $this->RiwayatPasien_model->get_penilaian_medis_psikiatrik_by_norawat($no_rawat),
                'igdPsikiatri' => $this->RiwayatPasien_model->get_asesmen_gawat_darurat_psikiatri_by_norawat($no_rawat),
                'geriatri' => $this->RiwayatPasien_model->get_asesmen_geriatri_by_norawat($no_rawat),
                'asesmenRehabMedik' => $this->RiwayatPasien_model->get_asesmen_medis_rehab_by_norawat($no_rawat),
                'asesmenUrologi' => $this->RiwayatPasien_model->get_asesmen_urologi_by_norawat($no_rawat),
