...
<div class="row">
  <!-- Kolom kiri: Form SOAP Perawat -->
  <div class="col-md-7">
    <div class="card shadow-sm border-primary mb-4">
      <div class="card-header bg-primary text-white py-2">
        <h5 class="m-0"><i class="fa fa-user-nurse"></i> SOAP Perawat</h5>
      </div>
      <div class="card-body">
        <form id="soapPerawatForm" method="POST">
          <?php if (isset($this->security)) : ?>
            <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
          <?php endif; ?>

          <input type="hidden" name="no_rawat" id="no_rawat" value="<?= html_escape($no_rawat) ?>">
          <input type="hidden" id="global_no_rkm_medis" value="<?= html_escape($no_rkm_medis) ?>">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <div class="form-group mb-2">
                ...
                <input type="date" name="tgl_perawatan" id="tgl_perawatan" class="form-control form-control-sm" tabindex="1">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group mb-2">
                <label for="jam_rawat" class="form-label"><i class="fa fa-clock-o"></i> Jam</label>
                <input type="text" name="jam_rawat" id="jam_rawat" class="form-control form-control-sm" placeholder="HH:MM:SS" tabindex="2">
              </div>
            </div>
          </div>
            ...
            <div class="card-body p-2">
              <div class="row">
                ...
                <div class="col-md-6 mb-2">
                  ...
                  <input type="number" step="0.1" name="lingkar_perut" id="lingkar_perut" class="form-control form-control-sm" 
                         placeholder="80" tabindex="13">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <textarea name="penilaian" id="penilaian" class="form-control" rows="3" 
                              placeholder="Penilaian kondisi pasien..." tabindex="16"></textarea>
                  </div>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <textarea name="instruksi" id="instruksi" class="form-control" rows="4" 
                              placeholder="Instruksi perawat..." tabindex="18"></textarea>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <textarea name="rtl" id="rtl" class="form-control" rows="3" 
          ...
          <div class="text-right mt-3">
            <button type="submit" class="btn btn-primary btn-sm" tabindex="20">
    ...
    <div class="card shadow-sm border-danger mb-4">
      ...
      <div class="card-body p-2" style="max-height: 600px; overflow-y: auto;">
        <table class="table table-sm table-bordered table-hover">
          ...
          <tbody id="soap-riwayat-body" class="text-center"></tbody>
        </table>
        <div id="soap-riwayat-footer"></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="card-body p-2">
    <div class="table-responsive">
      <table class="table table-sm table-bordered table-hover">
        ...
        <tbody id="hasil-soap-body" class="text-center"></tbody>
      </table>
      <div id="hasil-soap-footer"></div>
    </div>
  </div>
</div>
...
<script>
  ...
  window.API.soapPerawat = {
    getHasil:  "<?= site_url('perawat/soap-ralan/get-hasil'); ?>",
    getRiwayat:"<?= site_url('perawat/soap-ralan/get-riwayat-norm'); ?>",
    getDetail: "<?= site_url('perawat/soap-ralan/get-detail'); ?>",
    lastTTV:   "<?= site_url('perawat/soap-ralan/get-last-ttv'); ?>",
    save:      "<?= site_url('perawat/soap-ralan/save'); ?>",
    update:    "<?= site_url('perawat/soap-ralan/update'); ?>",
    delete:    "<?= site_url('perawat/soap-ralan/delete'); ?>"
  };
</script>
<script src="<?= asset_url('assets/js/perawat/soap_perawat.js') ?>"></script>