...
$config['base_url'] = 'http://127.0.0.1/moizhospitalapps/';
$config['webapps_root_url'] = 'http://127.0.0.1/webapps';
$config['webapps_root_fs'] = '/Applications/XAMPP/xamppfiles/htdocs/webapps';

$db['default']['pconnect'] = TRUE; // Persistent connection
$db['default']['db_debug'] = FALSE; // Production mode
...
|
*/
$config['encryption_key'] = '162570379f3ce99c9d7ae7cdc5085dd5';
