...
$(function () {
    ...
    function iconFor(kind) {
        const map = {
            ...
            penunjang: 'fa-user-md', laptind: 'fa-file-text', kfr: 'fa-file-medical', rehab: 'fa-wheelchair',
            anak: 'fa-child', bedah: 'fa-cut', tht: 'fa-deaf', jantung: 'fa-heartbeat',
            kulitdankelamin: 'fa-medkit', neurologi: 'fa-bolt', paru: 'fa-medkit',
            kandungan: 'fa-female', mata: 'fa-eye', psikiatrik: 'fa-puzzle-piece',
            igd_psikiatri: 'fa-ambulance',
            geriatri: 'fa-blind',
            urologi: 'fa-user-md'
        };
    ...
    function renderAsesmenAnak(d, helpers) {
        const { txt, hasData, hasContent, wrapSection, renderTTV } = helpers;
        if (hasData(d.anak)) {
            const a = d.anak.data || d.anak || {};
            if (hasContent(a, ['keluhan_utama', 'diagnosis', 'rps', 'tata'])) {
                const fisikRow = (lbl, val) => `<tr><td>${lbl}</td><td>${txt(val)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Jenis Anamnesis</b></td><td style="border:none">: ${txt(a.anamnesis)}${a.hubungan ? ' (' + txt(a.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(a.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(a.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(a.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(a.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(a.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(a.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(a.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(a.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(a.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(a.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">SpO2</div><div>${txt(a.spo)} %</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(a.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(a.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(a.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Keadaan Umum:</b> ${txt(a.keadaan)} | <b>Kesadaran:</b> ${txt(a.kesadaran)}</div>
                    <table class="print-table" style="width:100%;table-layout:fixed;margin-bottom:10px;">
                        <tr>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Kepala', a.kepala)}
                                    ${fisikRow('Mata', a.mata)}
                                    ${fisikRow('Gigi & Mulut', a.gigi)}
                                    ${fisikRow('THT', a.tht)}
                                    ${fisikRow('Thoraks', a.thoraks)}
                                </table>
                            </td>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Abdomen', a.abdomen)}
                                    ${fisikRow('Genital', a.genital)}
                                    ${fisikRow('Ekstremitas', a.ekstremitas)}
                                    ${fisikRow('Kulit', a.kulit)}
                                    <tr><td colspan="2"><b>Ket. Fisik:</b> ${txt(a.ket_fisik)}</td></tr>
                                </table>
                            </td>
                        </tr>
                    </table>
                    ${a.lokalis_url ? `<div style="text-align:center;margin:5px 0;"><b>Status Lokalis:</b><br><img src="${a.lokalis_url}" style="max-height:150px;width:auto;border:1px solid #ccc;"><br>${txt(a.ket_lokalis)}</div>` : (!a.ket_lokalis ? '' : `<div class="mb-1"><b>Status Lokalis:</b> ${txt(a.ket_lokalis)}</div>`)}
                    ${a.penunjang ? `<div class="mb-1 mt-2"><b>C. PEMERIKSAAN PENUNJANG</b></div><div class="mb-1">${txt(a.penunjang)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(a.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tatalaksana</b></td><td style="border:none">: ${txt(a.tata)}</td></tr>
                        ${a.konsul ? `<tr><td style="border:none;vertical-align:top"><b>Konsultasi</b></td><td style="border:none">: ${txt(a.konsul)}</td></tr>` : ''}
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS ANAK (PEDIATRI)', content);
            }
        }
        return '';
    }

    function renderAsesmenBedah(d, helpers) {
        const { txt, hasData, hasContent, wrapSection, renderTTV } = helpers;
        if (hasData(d.bedah)) {
            const b = d.bedah.data || d.bedah || {};
            if (hasContent(b, ['keluhan_utama', 'diagnosis', 'rps', 'tata'])) {
                const fisikRow = (lbl, val) => `<tr><td>${lbl}</td><td>${txt(val)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Jenis Anamnesis</b></td><td style="border:none">: ${txt(b.anamnesis)}${b.hubungan ? ' (' + txt(b.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(b.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(b.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(b.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(b.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(b.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(b.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(b.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(b.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(b.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(b.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">SpO2</div><div>${txt(b.spo)} %</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(b.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(b.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(b.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Keadaan Umum:</b> ${txt(b.keadaan)} | <b>Kesadaran:</b> ${txt(b.kesadaran)}</div>
                    <table class="print-table" style="width:100%;table-layout:fixed;margin-bottom:10px;">
                        <tr>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Kepala', b.kepala)}
                                    ${fisikRow('Mata', b.mata)}
                                    ${fisikRow('Gigi & Mulut', b.gigi)}
                                    ${fisikRow('Leher', b.leher)}
                                    ${fisikRow('Thoraks', b.thoraks)}
                                </table>
                            </td>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Abdomen', b.abdomen)}
                                    ${fisikRow('Genital', b.genital)}
                                    ${fisikRow('Ekstremitas', b.ekstremitas)}
                                    ${fisikRow('Kulit', b.kulit)}
                                    <tr><td colspan="2"><b>Ket. Fisik:</b> ${txt(b.ket_fisik)}</td></tr>
                                </table>
                            </td>
                        </tr>
                    </table>
                    ${b.lokalis_url ? `<div style="text-align:center;margin:5px 0;"><b>Status Lokalis:</b><br><img src="${b.lokalis_url}" style="max-height:150px;width:auto;border:1px solid #ccc;"><br>${txt(b.ket_lokalis)}</div>` : (!b.ket_lokalis ? '' : `<div class="mb-1"><b>Status Lokalis:</b> ${txt(b.ket_lokalis)}</div>`)}
                    ${b.penunjang ? `<div class="mb-1 mt-2"><b>C. PEMERIKSAAN PENUNJANG</b></div><div class="mb-1">${txt(b.penunjang)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(b.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tatalaksana</b></td><td style="border:none">: ${txt(b.tata)}</td></tr>
                        ${b.konsul ? `<tr><td style="border:none;vertical-align:top"><b>Konsultasi</b></td><td style="border:none">: ${txt(b.konsul)}</td></tr>` : ''}
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS BEDAH', content);
            }
        }
        return '';
    }

    function renderAsesmenTHT(d, helpers) {
        const { txt, hasData, hasContent, wrapSection, renderTTV } = helpers;
        if (hasData(d.tht)) {
            const t = d.tht.data || d.tht || {};
            if (hasContent(t, ['keluhan_utama', 'diagnosis', 'rps', 'tata'])) {
                const fisikRow = (lbl, val) => `<tr><td>${lbl}</td><td>${txt(val)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Jenis Anamnesis</b></td><td style="border:none">: ${txt(t.anamnesis)}${t.hubungan ? ' (' + txt(t.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(t.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(t.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(t.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(t.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(t.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(t.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(t.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(t.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(t.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(t.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">SpO2</div><div>${txt(t.spo)} %</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(t.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(t.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(t.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Keadaan Umum:</b> ${txt(t.keadaan)} | <b>Kesadaran:</b> ${txt(t.kesadaran)}</div>
                    <table class="print-table" style="width:100%;table-layout:fixed;margin-bottom:10px;">
                        <tr>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Kepala', t.kepala)}
                                    ${fisikRow('Mata', t.mata)}
                                    ${fisikRow('Gigi & Mulut', t.gigi)}
                                    ${fisikRow('THT', t.tht_area)}
                                    ${fisikRow('Leher', t.leher)}
                                </table>
                            </td>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Thoraks', t.thoraks)}
                                    ${fisikRow('Abdomen', t.abdomen)}
                                    ${fisikRow('Ekstremitas', t.ekstremitas)}
                                    ${fisikRow('Kulit', t.kulit)}
                                    <tr><td colspan="2"><b>Ket. Fisik:</b> ${txt(t.ket_fisik)}</td></tr>
                                </table>
                            </td>
                        </tr>
                    </table>
                    ${t.lokalis_url ? `<div style="text-align:center;margin:5px 0;"><b>Status Lokalis:</b><br><img src="${t.lokalis_url}" style="max-height:150px;width:auto;border:1px solid #ccc;"><br>${txt(t.ket_lokalis)}</div>` : (!t.ket_lokalis ? '' : `<div class="mb-1"><b>Status Lokalis:</b> ${txt(t.ket_lokalis)}</div>`)}
                    ${t.penunjang ? `<div class="mb-1 mt-2"><b>C. PEMERIKSAAN PENUNJANG</b></div><div class="mb-1">${txt(t.penunjang)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(t.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tatalaksana</b></td><td style="border:none">: ${txt(t.tata)}</td></tr>
                        ${t.konsul ? `<tr><td style="border:none;vertical-align:top"><b>Konsultasi</b></td><td style="border:none">: ${txt(t.konsul)}</td></tr>` : ''}
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS THT (OTOLARINGOLOGI)', content);
            }
        }
        return '';
    }

    function renderAsesmenJantung(d, helpers) {
        const { txt, hasData, hasContent, wrapSection, renderTTV } = helpers;
        if (hasData(d.jantung)) {
            const j = d.jantung.data || d.jantung || {};
            if (hasContent(j, ['keluhan_utama', 'diagnosis', 'rps', 'tata'])) {
                const fisikRow = (lbl, val) => `<tr><td>${lbl}</td><td>${txt(val)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Jenis Anamnesis</b></td><td style="border:none">: ${txt(j.anamnesis)}${j.hubungan ? ' (' + txt(j.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(j.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(j.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(j.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(j.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(j.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(j.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(j.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(j.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(j.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(j.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">SpO2</div><div>${txt(j.spo)} %</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(j.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(j.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(j.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Keadaan Umum:</b> ${txt(j.keadaan)} | <b>Kesadaran:</b> ${txt(j.kesadaran)}</div>
                    <table class="print-table" style="width:100%;table-layout:fixed;margin-bottom:10px;">
                        <tr>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Kepala', j.kepala)}
                                    ${fisikRow('Mata', j.mata)}
                                    ${fisikRow('Gigi & Mulut', j.gigi)}
                                    ${fisikRow('Leher', j.leher)}
                                    ${fisikRow('Thoraks', j.thoraks)}
                                </table>
                            </td>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Abdomen', j.abdomen)}
                                    ${fisikRow('Genital', j.genital)}
                                    ${fisikRow('Ekstremitas', j.ekstremitas)}
                                    ${fisikRow('Kulit', j.kulit)}
                                    <tr><td colspan="2"><b>Ket. Fisik:</b> ${txt(j.ket_fisik)}</td></tr>
                                </table>
                            </td>
                        </tr>
                    </table>
                    ${j.lokalis_url ? `<div style="text-align:center;margin:5px 0;"><b>Status Lokalis:</b><br><img src="${j.lokalis_url}" style="max-height:150px;width:auto;border:1px solid #ccc;"><br>${txt(j.ket_lokalis)}</div>` : (!j.ket_lokalis ? '' : `<div class="mb-1"><b>Status Lokalis:</b> ${txt(j.ket_lokalis)}</div>`)}
                    ${j.penunjang ? `<div class="mb-1 mt-2"><b>C. PEMERIKSAAN PENUNJANG</b></div><div class="mb-1">${txt(j.penunjang)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(j.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tatalaksana</b></td><td style="border:none">: ${txt(j.tata)}</td></tr>
                        ${j.konsul ? `<tr><td style="border:none;vertical-align:top"><b>Konsultasi</b></td><td style="border:none">: ${txt(j.konsul)}</td></tr>` : ''}
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS JANTUNG (KARDIOLOGI)', content);
            }
        }
        return '';
    }

    function renderAsesmenRehabMedik(d, helpers) {
        const { txt, hasData, hasContent, wrapSection, renderTTV } = helpers;
        if (hasData(d.asesmenRehabMedik)) {
            const r = d.asesmenRehabMedik.data || d.asesmenRehabMedik || {};
            if (hasContent(r, ['keluhan_utama', 'diagnosa_medis', 'rps'])) {
                const fisikRow = (lbl, val, ket) => `<tr><td>${lbl}</td><td>${txt(val)}</td><td>${txt(ket)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Anamnesis</b></td><td style="border:none">: ${txt(r.anamnesis)}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(r.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(r.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(r.rpd)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(r.alergi)}</td></tr>
                    </table>
                    
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                     <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(r.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(r.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(r.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(r.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(r.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nyeri</div><div>${txt(r.nyeri)} (${txt(r.skala_nyeri)})</div></div>
                    </div>
                    
                    <div class="mb-1 mt-1"><b>Pemeriksaan Sistemik:</b></div>
                    <table class="print-table" style="width:100%;">
                        <thead><tr><th>Sistem</th><th>Status</th><th>Keterangan</th></tr></thead>
                        ${fisikRow('Kepala/Leher', r.kepala, r.keterangan_kepala)}
                        ${fisikRow('Thorak', r.thoraks, r.keterangan_thorak)}
                        ${fisikRow('Abdomen', r.abdomen, r.keterangan_abdomen)}
                        ${fisikRow('Ekstremitas', r.ekstremitas, r.keterangan_ekstremitas)}
                        ${fisikRow('Columna', r.columna, r.keterangan_columna)}
                        ${fisikRow('Muskuloskeletal', r.muskulos, r.keterangan_muskulos)}
                    </table>
                    
                    <div class="mb-1 mt-2"><b>C. RISIKO & FUNGSIONAL</b></div>
                    <ul style="margin:0; padding-left:15px; font-size:10px;">
                        <li><b>Risiko Jatuh:</b> ${txt(r.resiko_jatuh)}</li>
                        <li><b>Risiko Nutrisional:</b> ${txt(r.resiko_nutrisional)}</li>
                        <li><b>Kebutuhan Fungsional:</b> ${txt(r.kebutuhan_fungsional)}</li>
                    </ul>

                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & PROGRAM TERAPI</b></div>
                     <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosa Medis</b></td><td style="border:none">: ${txt(r.diagnosa_medis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Diagnosa Fungsi</b></td><td style="border:none">: ${txt(r.diagnosa_fungsi)}</td></tr>
                    </table>
                    
                    <div style="margin-top:5px; border:1px solid #ccc; padding:5px;">
                        <div style="font-weight:bold; margin-bottom:4px;">PROGRAM TERAPI:</div>
                        <table class="print-table" style="width:100%;">
                             <thead><tr><th>Jenis</th><th>Tindakan</th></tr></thead>
                             <tr><td>Fisioterapi</td><td>${txt(r.fisio)}</td></tr>
                             <tr><td>Okupasi</td><td>${txt(r.okupasi)}</td></tr>
                             <tr><td>Wicara</td><td>${txt(r.wicara)}</td></tr>
                             <tr><td>Akupuntur</td><td>${txt(r.akupuntur)}</td></tr>
                             <tr><td>Lainnya</td><td>${txt(r.tatalain)}</td></tr>
                        </table>
                        <div style="margin-top:4px; font-size:10px;">
                            <b>Frekuensi:</b> ${txt(r.frekuensi_terapi)} | <b>Penunjang Lain:</b> ${txt(r.penunjang_lain)} 
                        </div>
                         <div style="margin-top:4px; font-size:10px;">
                            <b>Edukasi:</b> ${txt(r.edukasi)}
                        </div>
                    </div>`;
                return wrapSection('ASESMEN AWAL MEDIS REHAB MEDIK', content);
            }
        }
        return '';
    }

    function renderAsesmenKulitDanKelamin(d, helpers) {
        const { txt, hasData, hasContent, wrapSection } = helpers;
        if (hasData(d.kulitdankelamin)) {
            const k = d.kulitdankelamin.data || d.kulitdankelamin || {};
            if (hasContent(k, ['keluhan_utama', 'diagnosis', 'rps', 'tata'])) {
                const fisikRow = (lbl, val) => `<tr><td>${lbl}</td><td>${txt(val)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Jenis Anamnesis</b></td><td style="border:none">: ${txt(k.anamnesis)}${k.hubungan ? ' (' + txt(k.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(k.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(k.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(k.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(k.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(k.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(k.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(k.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(k.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(k.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(k.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">SpO2</div><div>${txt(k.spo)} %</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(k.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(k.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(k.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Keadaan Umum:</b> ${txt(k.keadaan)} | <b>Kesadaran:</b> ${txt(k.kesadaran)}</div>
                    <table class="print-table" style="width:100%;table-layout:fixed;margin-bottom:10px;">
                        <tr>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Kepala', k.kepala)}
                                    ${fisikRow('Mata', k.mata)}
                                    ${fisikRow('Gigi & Mulut', k.gigi)}
                                    ${fisikRow('Leher', k.leher)}
                                    ${fisikRow('Thoraks', k.thoraks)}
                                </table>
                            </td>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Abdomen', k.abdomen)}
                                    ${fisikRow('Genital', k.genital)}
                                    ${fisikRow('Ekstremitas', k.ekstremitas)}
                                    ${fisikRow('Kulit', k.kulit)}
                                    <tr><td colspan="2"><b>Ket. Fisik:</b> ${txt(k.ket_fisik)}</td></tr>
                                </table>
                            </td>
                        </tr>
                    </table>
                    ${k.lokalis_url ? `<div style="text-align:center;margin:5px 0;"><b>Status Lokalis:</b><br><img src="${k.lokalis_url}" style="max-height:150px;width:auto;border:1px solid #ccc;"><br>${txt(k.ket_lokalis)}</div>` : (!k.ket_lokalis ? '' : `<div class="mb-1"><b>Status Lokalis:</b> ${txt(k.ket_lokalis)}</div>`)}
                    ${k.penunjang ? `<div class="mb-1 mt-2"><b>C. PEMERIKSAAN PENUNJANG</b></div><div class="mb-1">${txt(k.penunjang)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(k.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tatalaksana</b></td><td style="border:none">: ${txt(k.tata)}</td></tr>
                        ${k.konsul ? `<tr><td style="border:none;vertical-align:top"><b>Konsultasi</b></td><td style="border:none">: ${txt(k.konsul)}</td></tr>` : ''}
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS KULIT & KELAMIN (DERMATOLOGI)', content);
            }
        }
        return '';
    }

    function renderAsesmenNeurologi(d, helpers) {
        const { txt, hasData, hasContent, wrapSection } = helpers;
        if (hasData(d.neurologi)) {
            const n = d.neurologi.data || d.neurologi || {};
            if (hasContent(n, ['keluhan_utama', 'diagnosis', 'rps', 'tata'])) {
                const fisikRow = (lbl, val) => `<tr><td>${lbl}</td><td>${txt(val)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Jenis Anamnesis</b></td><td style="border:none">: ${txt(n.anamnesis)}${n.hubungan ? ' (' + txt(n.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(n.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(n.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(n.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(n.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(n.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(n.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(n.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(n.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(n.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(n.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">SpO2</div><div>${txt(n.spo)} %</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(n.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(n.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(n.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Keadaan Umum:</b> ${txt(n.keadaan)} | <b>Kesadaran:</b> ${txt(n.kesadaran)}</div>
                    <table class="print-table" style="width:100%;table-layout:fixed;margin-bottom:10px;">
                        <tr>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Kepala', n.kepala)}
                                    ${fisikRow('Mata', n.mata)}
                                    ${fisikRow('Gigi & Mulut', n.gigi)}
                                    ${fisikRow('Leher', n.leher)}
                                    ${fisikRow('Thoraks', n.thoraks)}
                                </table>
                            </td>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Abdomen', n.abdomen)}
                                    ${fisikRow('Genital', n.genital)}
                                    ${fisikRow('Ekstremitas', n.ekstremitas)}
                                    ${fisikRow('Kulit', n.kulit)}
                                    <tr><td colspan="2"><b>Ket. Fisik:</b> ${txt(n.ket_fisik)}</td></tr>
                                </table>
                            </td>
                        </tr>
                    </table>
                    ${n.lokalis_url ? `<div style="text-align:center;margin:5px 0;"><b>Status Lokalis:</b><br><img src="${n.lokalis_url}" style="max-height:150px;width:auto;border:1px solid #ccc;"><br>${txt(n.ket_lokalis)}</div>` : (!n.ket_lokalis ? '' : `<div class="mb-1"><b>Status Lokalis:</b> ${txt(n.ket_lokalis)}</div>`)}
                    ${n.penunjang ? `<div class="mb-1 mt-2"><b>C. PEMERIKSAAN PENUNJANG</b></div><div class="mb-1">${txt(n.penunjang)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(n.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tatalaksana</b></td><td style="border:none">: ${txt(n.tata)}</td></tr>
                        ${n.konsul ? `<tr><td style="border:none;vertical-align:top"><b>Konsultasi</b></td><td style="border:none">: ${txt(n.konsul)}</td></tr>` : ''}
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS NEUROLOGI', content);
            }
        }
        return '';
    }

    function renderAsesmenParu(d, helpers) {
        const { txt, hasData, hasContent, wrapSection } = helpers;
        if (hasData(d.paru)) {
            const p = d.paru.data || d.paru || {};
            if (hasContent(p, ['keluhan_utama', 'diagnosis', 'rps', 'tata'])) {
                const fisikRow = (lbl, val) => `<tr><td>${lbl}</td><td>${txt(val)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Jenis Anamnesis</b></td><td style="border:none">: ${txt(p.anamnesis)}${p.hubungan ? ' (' + txt(p.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(p.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(p.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(p.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(p.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(p.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(p.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(p.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(p.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(p.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(p.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">SpO2</div><div>${txt(p.spo)} %</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(p.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(p.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(p.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Keadaan Umum:</b> ${txt(p.keadaan)} | <b>Kesadaran:</b> ${txt(p.kesadaran)}</div>
                    <table class="print-table" style="width:100%;table-layout:fixed;margin-bottom:10px;">
                        <tr>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Kepala', p.kepala)}
                                    ${fisikRow('Mata', p.mata)}
                                    ${fisikRow('Gigi & Mulut', p.gigi)}
                                    ${fisikRow('Leher', p.leher)}
                                    ${fisikRow('Thoraks', p.thoraks)}
                                </table>
                            </td>
                            <td style="width:50%;vertical-align:top;padding:0;border:none;">
                                <table class="print-table" style="width:100%;margin:0;">
                                    <thead><tr><th>Area</th><th>Status</th></tr></thead>
                                    ${fisikRow('Abdomen', p.abdomen)}
                                    ${fisikRow('Genital', p.genital)}
                                    ${fisikRow('Ekstremitas', p.ekstremitas)}
                                    ${fisikRow('Kulit', p.kulit)}
                                    <tr><td colspan="2"><b>Ket. Fisik:</b> ${txt(p.ket_fisik)}</td></tr>
                                </table>
                            </td>
                        </tr>
                    </table>
                    ${p.lokalis_url ? `<div style="text-align:center;margin:5px 0;"><b>Status Lokalis:</b><br><img src="${p.lokalis_url}" style="max-height:150px;width:auto;border:1px solid #ccc;"><br>${txt(p.ket_lokalis)}</div>` : (!p.ket_lokalis ? '' : `<div class="mb-1"><b>Status Lokalis:</b> ${txt(p.ket_lokalis)}</div>`)}
                    ${p.penunjang ? `<div class="mb-1 mt-2"><b>C. PEMERIKSAAN PENUNJANG</b></div><div class="mb-1">${txt(p.penunjang)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(p.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tatalaksana</b></td><td style="border:none">: ${txt(p.tata)}</td></tr>
                        ${p.konsul ? `<tr><td style="border:none;vertical-align:top"><b>Konsultasi</b></td><td style="border:none">: ${txt(p.konsul)}</td></tr>` : ''}
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS PARU (PULMONOLOGI)', content);
            }
        }
        return '';
    }

    function renderAsesmenGawatDaruratPsikiatri(d, helpers) {
        const { txt, hasData, hasContent, wrapSection } = helpers;
        if (hasData(d.igdPsikiatri)) {
            const ps = d.igdPsikiatri.data || d.igdPsikiatri || {};
            if (hasContent(ps, ['keluhan_utama', 'diagnosis', 'rps'])) {
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Anamnesis</b></td><td style="border:none">: ${txt(ps.anamnesis)}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(ps.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(ps.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(ps.rpd)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(ps.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(ps.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(ps.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(ps.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(ps.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(ps.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(ps.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(ps.gcs)}</div></div>
                        <div class="ttv-item"><div class="ttv-label">Kesadaran</div><div>${txt(ps.kesadaran)}</div></div>
                    </div>
                    ${ps.pemeriksaan_fisik ? `<div class="mb-1 mt-1"><b>Pemeriksaan Fisik:</b> ${txt(ps.pemeriksaan_fisik)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>C. STATUS PSIKIATRI</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Penampilan</b></td><td style="border:none">: ${txt(ps.penampilan)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Kesadaran</b></td><td style="border:none">: ${txt(ps.kesadaran_psikiatri)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Orientasi</b></td><td style="border:none">: ${txt(ps.orientasi)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Daya Ingat</b></td><td style="border:none">: ${txt(ps.daya_ingat)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Proses Pikir</b></td><td style="border:none">: ${txt(ps.proses_pikir)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Isi Pikir</b></td><td style="border:none">: ${txt(ps.isi_pikir)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Afek & Emosi</b></td><td style="border:none">: ${txt(ps.afek_emosi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(ps.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Terapi</b></td><td style="border:none">: ${txt(ps.terapi)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tindakan</b></td><td style="border:none">: ${txt(ps.tindakan)}</td></tr>
                    </table>`;
                return wrapSection('ASESMEN GAWAT DARURAT PSIKIATRI', content);
            }
        }
        return '';
    }

    function renderAsesmenGeriatri(d, helpers) {
        const { txt, hasData, hasContent, wrapSection } = helpers;
        if (hasData(d.geriatri)) {
            const g = d.geriatri.data || d.geriatri || {};
            if (hasContent(g, ['keluhan_utama', 'diagnosis', 'rps'])) {
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Anamnesis</b></td><td style="border:none">: ${txt(g.anamnesis)}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(g.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(g.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(g.rpd)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(g.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(g.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(g.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(g.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(g.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(g.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(g.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">IMT</div><div>${txt(g.imt)}</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(g.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Kesadaran:</b> ${txt(g.kesadaran)}</div>
                    ${g.pemeriksaan_fisik ? `<div class="mb-1 mt-1"><b>Pemeriksaan Fisik:</b> ${txt(g.pemeriksaan_fisik)}</div>` : ''}
                    ${g.lokalis_url ? `<div style="text-align:center;margin:5px 0;"><b>Status Lokalis:</b><br><img src="${g.lokalis_url}" style="max-height:150px;width:auto;border:1px solid #ccc;"><br>${txt(g.ket_lokalis)}</div>` : ''}
                    <div class="mb-1 mt-2"><b>C. ASESMEN GERIATRI</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Status Fungsional</b></td><td style="border:none">: ${txt(g.status_fungsional)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Risiko Jatuh</b></td><td style="border:none">: ${txt(g.risiko_jatuh)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Status Gizi</b></td><td style="border:none">: ${txt(g.status_gizi)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Status Mental</b></td><td style="border:none">: ${txt(g.status_mental)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Depresi</b></td><td style="border:none">: ${txt(g.depresi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(g.diagnosis)}</td></tr>
                        ${g.diagnosis2 ? `<tr><td style="border:none;vertical-align:top"><b>Diagnosis Sekunder</b></td><td style="border:none">: ${txt(g.diagnosis2)}</td></tr>` : ''}
                        ${g.permasalahan ? `<tr><td style="border:none;vertical-align:top"><b>Permasalahan</b></td><td style="border:none">: ${txt(g.permasalahan)}</td></tr>` : ''}
                        <tr><td style="border:none;vertical-align:top"><b>Terapi</b></td><td style="border:none">: ${txt(g.terapi)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tindakan</b></td><td style="border:none">: ${txt(g.tindakan)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Edukasi</b></td><td style="border:none">: ${txt(g.edukasi)}</td></tr>
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS GERIATRI', content);
            }
        }
        return '';
    }

    function renderAsesmenPsikiatrik(d, helpers) {
        const { txt, hasData, hasContent, wrapSection } = helpers;
        if (hasData(d.psikiatrik)) {
            const ps = d.psikiatrik.data || d.psikiatrik || {};
            if (hasContent(ps, ['keluhan_utama', 'diagnosis', 'anamnesis'])) {
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Jenis Anamnesis</b></td><td style="border:none">: ${txt(ps.anamnesis)}${ps.hubungan ? ' (' + txt(ps.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(ps.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(ps.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(ps.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(ps.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(ps.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(ps.alergi)}</td></tr>
                    </table>
                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                    <div class="ttv-grid">
                        ...
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(ps.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(ps.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">SpO2</div><div>${txt(ps.spo)} %</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(ps.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(ps.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">GCS</div><div>${txt(ps.gcs)}</div></div>
                    </div>
                    <div class="mb-1"><b>Keadaan Umum:</b> ${txt(ps.keadaan)} | <b>Kesadaran:</b> ${txt(ps.kesadaran)}</div>
                    <table class="print-table" style="width:100%;margin-top:5px;">
                        <thead><tr><th>Kepala</th><th>THT</th><th>Thoraks</th><th>Abdomen</th><th>Genital</th><th>Ekstremitas</th><th>Kulit</th></tr></thead>
                        <tbody>
                            <tr>
                                <td>${txt(ps.kepala)}</td>
                                <td>${txt(ps.tht)}</td>
                                <td>${txt(ps.thoraks)}</td>
                                <td>${txt(ps.abdomen)}</td>
                                <td>${txt(ps.genital)}</td>
                                <td>${txt(ps.ekstremitas)}</td>
                                <td>${txt(ps.kulit)}</td>
                            </tr>
                        </tbody>
                    </table>
                    ${ps.ket_fisik ? `<div class="mb-1 mt-1"><b>Keterangan Fisik:</b> ${txt(ps.ket_fisik)}</div>` : ''}
                    ${ps.penunjang ? `<div class="mb-1 mt-1"><b>Pemeriksaan Penunjang:</b> ${txt(ps.penunjang)}</div>` : ''}
                    
                    <div class="mb-1 mt-2"><b>C. STATUS PSIKIATRIK</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="25%" style="border:none;vertical-align:top"><b>Penampilan</b></td><td style="border:none">: ${txt(ps.penampilan)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Pembicaraan</b></td><td style="border:none">: ${txt(ps.pembicaraan)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Psikomotor</b></td><td style="border:none">: ${txt(ps.psikomotor)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Sikap</b></td><td style="border:none">: ${txt(ps.sikap)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Mood / Afek</b></td><td style="border:none">: ${txt(ps.mood)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Fungsi Kognitif</b></td><td style="border:none">: ${txt(ps.fungsi_kognitif)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Gangguan Persepsi</b></td><td style="border:none">: ${txt(ps.gangguan_persepsi)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Proses Pikir</b></td><td style="border:none">: ${txt(ps.proses_pikir)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Pengendalian Impuls</b></td><td style="border:none">: ${txt(ps.pengendalian_impuls)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tilikan</b></td><td style="border:none">: ${txt(ps.tilikan)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Daya Nilai RTA</b></td><td style="border:none">: ${txt(ps.rta)}</td></tr>
                    </table>
                    
                    <div class="mb-1 mt-2"><b>D. DIAGNOSIS & TATALAKSANA</b></div>
                    <table class="print-table" style="border:none">
                        <tr><td width="20%" style="border:none;vertical-align:top"><b>Diagnosis</b></td><td style="border:none">: ${txt(ps.diagnosis)}</td></tr>
                        <tr><td style="border:none;vertical-align:top"><b>Tatalaksana</b></td><td style="border:none">: ${txt(ps.tata)}</td></tr>
                        ${ps.konsulrujuk ? `<tr><td style="border:none;vertical-align:top"><b>Konsul/Rujuk</b></td><td style="border:none">: ${txt(ps.konsulrujuk)}</td></tr>` : ''}
                    </table>`;
                return wrapSection('ASESMEN AWAL MEDIS PSIKIATRIK', content);
            }
        }
        return '';
    }

    function renderAsesmenUrologi(d, helpers) {
        const { txt, hasData, hasContent, wrapSection, renderTTV } = helpers;
        if (hasData(d.asesmenUrologi)) {
            const u = d.asesmenUrologi.data || d.asesmenUrologi || {};
            if (hasContent(u, ['keluhan_utama', 'diagnosis', 'rps'])) {
                const fisikRow = (lbl, val, ket) => `<tr><td>${lbl}</td><td>${txt(val)}</td><td>${txt(ket)}</td></tr>`;
                const content = `
                    <div class="mb-1"><b>A. ANAMNESIS</b></div>
                     <table class="print-table" style="border:none">
                        <tr><td style="border:none; width:140px; min-width:140px; white-space:nowrap"><b>Anamnesis</b></td><td style="border:none">: ${txt(u.anamnesis)}${u.hubungan ? ' (' + txt(u.hubungan) + ')' : ''}</td></tr>
                        <tr><td style="border:none"><b>Keluhan Utama</b></td><td style="border:none">: ${txt(u.keluhan_utama)}</td></tr>
                        <tr><td style="border:none"><b>RPS</b></td><td style="border:none">: ${txt(u.rps)}</td></tr>
                        <tr><td style="border:none"><b>RPD</b></td><td style="border:none">: ${txt(u.rpd)}</td></tr>
                        <tr><td style="border:none"><b>RPK</b></td><td style="border:none">: ${txt(u.rpk)}</td></tr>
                        <tr><td style="border:none"><b>RPO</b></td><td style="border:none">: ${txt(u.rpo)}</td></tr>
                        <tr><td style="border:none"><b>Alergi</b></td><td style="border:none">: ${txt(u.alergi)}</td></tr>
                        <tr><td style="border:none"><b>Riw. Op Urologi</b></td><td style="border:none">: ${txt(u.riwayat_operasi_urologi)}</td></tr>
                    </table>

                    <div class="mb-1 mt-2"><b>B. PEMERIKSAAN FISIK & TTV</b></div>
                     <div class="ttv-grid">
                        <div class="ttv-item"><div class="ttv-label">TD</div><div>${txt(u.td)} mmHg</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nadi</div><div>${txt(u.nadi)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">RR</div><div>${txt(u.rr)} x/m</div></div>
                        <div class="ttv-item"><div class="ttv-label">Suhu</div><div>${txt(u.suhu)} °C</div></div>
                        <div class="ttv-item"><div class="ttv-label">BB</div><div>${txt(u.bb)} Kg</div></div>
                        <div class="ttv-item"><div class="ttv-label">TB</div><div>${txt(u.tb)} Cm</div></div>
                        <div class="ttv-item"><div class="ttv-label">Nyeri</div><div>${txt(u.nyeri)}</div></div>
                    </div>
                     <div class="mb-1"><b>Keadaan Umum:</b> ${txt(u.keadaan_umum)} | <b>Status Nutrisi:</b> ${txt(u.status_nutrisi)}</div>

                    <div class="mb-1 mt-1"><b>Pemeriksaan Sistemik:</b></div>
                    <table class="print-table" style="width:100%;">
                        <thead><tr><th>Area</th><th>Hasil</th><th>Keterangan</th></tr></thead>
                        ${fisikRow('Thoraks', u.thoraks, u.keterangan_thoraks)}
                        ${fisikRow('Abdomen', u.abdomen, u.keterangan_abdomen)}
                        ${fisikRow('Ekstremitas', u.ekstrimitas, u.keterangan_ekstrimitas)}
                    </table>
                     ${u.lainnya ? `<div class="mb-1 mt-1"><b>Pemeriksaan Lainnya:</b> ${txt(u.lainnya)}</div>` : ''}

                    <div class="mb-1 mt-1"><b>Status Urologi:</b></div>
                    <ul style="margin:0; padding-left:15px; font-size:10px;">
                        <li><b>Nyeri Ketok CVA:</b> ${txt(u.nyeri_ketok_cva)}</li>
                        <li><b>Genitalia Eksternal:</b> ${txt(u.genitalia_eksternal)}</li>
                        <li><b>Colok Dubur:</b> ${txt(u.colok_dubur)}</li>
                    </ul>

                    <div class="mb-1 mt-2"><b>C. PEMERIKSAAN PENUNJANG</b></div>
                    <table class="print-table" style="border:none">
                         <tr><td width="20%" style="border:none;vertical-align:top"><b>Urinalisis</b></td><td style="border:none">: ${txt(u.urinalisis)}</td></tr>
                         <tr><td style="border:none;vertical-align:top"><b>Darah</b></td><td style="border:none">: ${txt(u.darah)}</td></tr>
                         <tr><td style="border:none;vertical-align:top"><b>USG Urologi</b></td><td style="border:none">: ${txt(u.usg_urologi)}</td></tr>
                         <tr><td style="border:none;vertical-align:top"><b>Radiologi</b></td><td style="border:none">: ${txt(u.radiologi)}</td></tr>
                         <tr><td style="border:none;vertical-align:top"><b>Lainnya</b></td><td style="border:none">: ${txt(u.penunjang_lain)}</td></tr>
                    </table>
                     ...
                     <div style="border:1px solid #ccc; padding:5px; background:#f9f9f9;">
                         ...
                         <div style="margin-bottom:5px;"><b>Utama:</b> ${txt(u.diagnosis)}</div>
                         ${u.diagnosis2 ? `<div style="font-size:10px;"><b>Sekunder:</b> ${txt(u.diagnosis2)}</div>` : ''}
                          ${u.permasalahan ? `<div style="font-size:10px;"><b>Permasalahan:</b> ${txt(u.permasalahan)}</div>` : ''}
                         
                         <div style="font-weight:bold; color:#000; margin-bottom:3px; margin-top:5px; text-decoration:underline;">TATALAKSANA:</div>
                         <ul style="margin:0; padding-left:15px;">
                            <li><b>Terapi:</b> ${txt(u.terapi)}</li>
                            <li><b>Tindakan:</b> ${txt(u.tindakan)}</li>
                            <li><b>Edukasi:</b> ${txt(u.edukasi)}</li>
                         </ul>
                     </div>
                 `;
                return wrapSection('ASESMEN AWAL MEDIS UROLOGI', content);
            }
        }
        return '';
    }
    ...
    window.generateReportHtml = (d) => {
        ...
        // === PENILAIAN MEDIS ANAK (PEDIATRI) ===
        htmlAssess += renderAsesmenAnak(d, helpers);

        // === PENILAIAN MEDIS BEDAH ===
        htmlAssess += renderAsesmenBedah(d, helpers);

        // === PENILAIAN MEDIS THT ===
        htmlAssess += renderAsesmenTHT(d, helpers);

        // === PENILAIAN MEDIS JANTUNG (KARDIOLOGI) ===
        htmlAssess += renderAsesmenJantung(d, helpers);

        // === PENILAIAN MEDIS KULIT DAN KELAMIN (DERMATOLOGI) ===
        htmlAssess += renderAsesmenKulitDanKelamin(d, helpers);

        // === PENILAIAN MEDIS NEUROLOGI ===
        htmlAssess += renderAsesmenNeurologi(d, helpers);

        // === PENILAIAN MEDIS PARU (PULMONOLOGI) ===
        htmlAssess += renderAsesmenParu(d, helpers);

        // === PENILAIAN MEDIS PSIKIATRIK ===
        htmlAssess += renderAsesmenPsikiatrik(d, helpers);

        // === ASESMEN GAWAT DARURAT PSIKIATRI ===
        htmlAssess += renderAsesmenGawatDaruratPsikiatri(d, helpers);

        // === ASESMEN GERIATRI ===
        htmlAssess += renderAsesmenGeriatri(d, helpers);

        // === PENILAIAN MEDIS REHAB MEDIK ===
        htmlAssess += renderAsesmenRehabMedik(d, helpers);

        // === PENILAIAN MEDIS UROLOGI ===
        htmlAssess += renderAsesmenUrologi(d, helpers);
    ...
    function loadFullDetailInto($container, base) {
        ...
        $.when(
            ...
            $.get(API_URLS.RP_PENILAIAN_ANAK, { no_rawat: norawat }),
            $.get(API_URLS.RP_PENILAIAN_BEDAH, { no_rawat: norawat }),
            $.get(API_URLS.RP_PENILAIAN_THT, { no_rawat: norawat }),
            ...
            $.get(API_URLS.RP_ASESMEN_IGD_PSIKIATRI, { no_rawat: norawat }),
            $.get(API_URLS.RP_ASESMEN_GERIATRI, { no_rawat: norawat }),
            $.get(API_URLS.RP_ASESMEN_REHAB_MEDIK, { no_rawat: norawat }),
            $.get(API_URLS.RP_ASESMEN_UROLOGI, { no_rawat: norawat }),
            $.get(API_URLS.RP_ASESMEN_UMUM, { no_rawat: norawat })
        ).done(function (
            ...
            igdPsikiatriRes, geriatriRes, asesmenRehabMedikRes, asesmenUrologiRes, umumRes
        ) {
            ...
            const igdPsikiatri = J(igdPsikiatriRes);
            const geriatri = J(geriatriRes);
            const asesmenRehabMedik = J(asesmenRehabMedikRes);
            const asesmenUrologi = J(asesmenUrologiRes);
            const umum = J(umumRes);
            ...
            const printPayload = {
                ...
                psikiatrik, igdPsikiatri, geriatri, asesmenRehabMedik, asesmenUrologi, umum,
                base: base
            };
            ...
            function renderSpesialis(dataObj, title, icon, colorTheme, isOrtho = false) {
                ...
                // 2. FISIK & VITAL
                html += `<div style="margin-bottom:20px;" >
                             <h5 style="font-size:12px !important; font-weight:700 !important; color:#2dce89 !important; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #2dce89; display:inline-block; padding-bottom:4px;">
                ...
                if (!isOrtho && (d.lab || d.rad || d.penunjanglain)) {
                    html += `<div style="margin-bottom:20px;">
                        <h5 style="font-size:12px !important; font-weight:700 !important; color:#8b5cf6 !important; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #8b5cf6; display:inline-block; padding-bottom:4px;">
            ...
            function renderPenilaianMata() {
                ...
                if (hasKeys(data, ['keluhan_utama', 'diagnosis', 'visuskanan', 'visuskiri'])) {
                    ...
                    // 1. ANAMNESIS
                    html += `<div style="margin-bottom:20px;">
                            <h5 style="font-size:12px !important; font-weight:700 !important; color:#f59e0b !important; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #f59e0b; display:inline-block; padding-bottom:4px;">
                                <i class="fa fa-history"></i> Anamnesis
                            </h5>
                            <table style="width:100%; font-size:13px; border-collapse:collapse;">
                    ...
                    cardsToShow.push(cardWrap('soap', 'Asesmen Awal Medis Mata', html));
                }
            }
            ...
            if (typeof detail_penilaian_medis_kandungan !== 'undefined' && detail_penilaian_medis_kandungan && detail_penilaian_medis_kandungan.data) {
                ...
                if (kd.keluhan_utama || kd.diagnosis || kd.td) {
                    let html = `
                        ...
                        <div>
                            <h5 style="font-size:12px !important; font-weight:700 !important; color:#f44336 !important; text-transform:uppercase; margin-bottom:10px; border-bottom:2px solid #f44336; display:inline-block; padding-bottom:4px;">
                    ...
                    `;
                    cardsToShow.push(cardWrap('kandungan', 'Asesmen Medis Kandungan', html));
                }
            }
            ...
            // === RENDER PENILAIAN MEDIS THT (SUPER COMPLETE) ===
            function renderPenilaianTHT() {
                ...
                if (hasKeys(data, ['keluhan_utama', 'diagnosis'])) {
                    ...
                    html += '</div>';
                    if (data.status_nutrisi) {
                        html += '<div style="margin-bottom:8px;"><b>Status Nutrisi:</b> ' + escHtml(data.status_nutrisi) + '</div>';
                    }
                    if (data.kondisi) {
                        html += '<div style="border:1px solid #e5e7eb; border-radius:8px; padding:12px; background:#f9fafb;">';
                        html += '<b>Kondisi Umum:</b><br>' + escHtml(data.kondisi);
                        html += '</div>';
                    }
                    html += '</div>';
                    ...
                    if (data.lokalis_url || data.ket_lokalis) {
                        html += '<div style="margin-bottom:20px;">';
                        html += '<h5 style="font-size:12px !important; font-weight:700 !important; color:#8b5cf6 !important; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #8b5cf6; display:inline-block; padding-bottom:4px;">';
                        html += '<i class="fa fa-image"></i> III. Status Lokalis THT</h5>';
                        if (data.ket_lokalis) {
                            html += '<div style="margin-bottom:8px; font-size:12px;"><b>Keterangan:</b> ' + escHtml(data.ket_lokalis) + '</div>';
                        }
                        if (data.lokalis_url) {
                    ...
                    // IV. PEMERIKSAAN PENUNJANG
                    if (data.lab || data.rad || data.tes_pendengaran || data.penunjang) {
                        html += '<div style="margin-bottom:20px;">';
                        html += '<h5 style="font-size:12px !important; font-weight:700 !important; color:#6366f1 !important; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #6366f1; display:inline-block; padding-bottom:4px;">';
                        html += '<i class="fa fa-flask"></i> IV. Pemeriksaan Penunjang</h5>';
                        html += '<table style="width:100%; font-size:13px; border-collapse:collapse;">';
                        if (data.lab) html += row('Laboratorium', data.lab);
                        if (data.rad) html += row('Radiologi', data.rad);
                        if (data.tes_pendengaran) html += row('Tes Pendengaran', data.tes_pendengaran);
                        if (data.penunjang) html += row('Penunjang Lain', data.penunjang);
                        html += '</table></div>';
                    }
                    ...
                    html += '<div style="font-size:11px; color:#f44336; font-weight:700; text-transform:uppercase; margin-bottom:4px;">Diagnosis Utama</div>';
                    html += '<div style="font-size:14px; font-weight:600; color:#32325d;">' + escHtml(data.diagnosis || '-') + '</div>';
                    if (data.diagnosisbanding) {
                        html += '<hr style="border-top:1px dashed #fcd34d; margin:8px 0;"><div style="font-size:11px; color:#888;"><b>Diagnosis Banding:</b> ' + escHtml(data.diagnosisbanding) + '</div>';
                    }
                    if (data.permasalahan) {
                        html += '<hr style="border-top:1px dashed #fcd34d; margin:8px 0;"><div style="font-size:11px; color:#888;"><b>Permasalahan:</b> ' + escHtml(data.permasalahan) + '</div>';
                    }
                    ...
                    if (data.terapi) html += '<li><b>Terapi/Pengobatan:</b> ' + escHtml(data.terapi) + '</li>';
                    if (data.tindakan) html += '<li><b>Tindakan:</b> ' + escHtml(data.tindakan) + '</li>';
                    if (data.tatalaksana) html += '<li><b>Tatalaksana:</b> ' + escHtml(data.tatalaksana) + '</li>';
                    if (data.edukasi) html += '<li><b>Edukasi:</b> ' + escHtml(data.edukasi) + '</li>';
                    html += '</ul></div></div>';
            ...
            // === RENDER PENILAIAN MEDIS JANTUNG (SUPER COMPLETE) ===
            function renderPenilaianJantung() {
                ...
                if (hasKeys(data, ['keluhan_utama', 'diagnosis'])) {
                    ...
                    html += row('Riw. Penyakit Sekarang', data.rps);
                    html += row('Riw. Penyakit Dahulu', data.rpd);
                    if (data.rpk) html += row('Riw. Penyakit Keluarga', data.rpk);
                    html += row('Riw. Penggunaan Obat', data.rpo);
                    html += row('Riwayat Alergi', data.alergi);
                    html += '</table></div>';
                    ...
                    if (data.keadaan_umum) {
                        html += '<div style="margin-bottom:8px;"><b>Keadaan Umum:</b> ' + escHtml(data.keadaan_umum) + '</div>';
                    }
                    html += '</div>';

                    // III. PEMERIKSAAN SISTEMIK
                    if (data.jantung || data.paru || data.ekstrimitas) {
                        html += '<div style="margin-bottom:20px; border:1px solid #e5e7eb; border-radius:8px; padding:12px; background:#f9fafb;">';
                        html += '<div style="font-size:12px; font-weight:700; margin-bottom:10px; color:#6366f1;"><i class="fa fa-user-md"></i> III. Pemeriksaan Sistemik</div>';
                        html += '<div style="display:grid; grid-template-columns: repeat(3, 1fr); gap:12px; font-size:12px;">';
                        html += '<div>';
                        if (data.jantung) {
                            html += '<div style="margin-bottom:6px;"><b>Jantung:</b> ' + escHtml(data.jantung) + '</div>';
                            if (data.keterangan_jantung) html += '<div style="margin-bottom:6px; font-size:11px; color:#888;"><i>Ket: ' + escHtml(data.keterangan_jantung) + '</i></div>';
                        }
                        html += '</div><div>';
                        if (data.paru) {
                            html += '<div style="margin-bottom:6px;"><b>Paru:</b> ' + escHtml(data.paru) + '</div>';
                            if (data.keterangan_paru) html += '<div style="margin-bottom:6px; font-size:11px; color:#888;"><i>Ket: ' + escHtml(data.keterangan_paru) + '</i></div>';
                        }
                        html += '</div><div>';
                        if (data.ekstrimitas) {
                            html += '<div style="margin-bottom:6px;"><b>Ekstrimitas:</b> ' + escHtml(data.ekstrimitas) + '</div>';
                            if (data.keterangan_ekstrimitas) html += '<div style="margin-bottom:6px; font-size:11px; color:#888;"><i>Ket: ' + escHtml(data.keterangan_ekstrimitas) + '</i></div>';
                        }
                        html += '</div></div>';
                        if (data.lainnya) {
                    ...
                    // IV. PEMERIKSAAN PENUNJANG
                    if (data.lab || data.ekg || data.penunjang_lain) {
                        html += '<div style="margin-bottom:20px;">';
                        html += '<h5 style="font-size:12px !important; font-weight:700 !important; color:#6366f1 !important; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #6366f1; display:inline-block; padding-bottom:4px;">';
                        html += '<i class="fa fa-flask"></i> IV. Pemeriksaan Penunjang</h5>';
                        html += '<table style="width:100%; font-size:13px; border-collapse:collapse;">';
                        if (data.lab) html += row('Laboratorium', data.lab);
                        if (data.ekg) html += row('EKG', data.ekg);
                        if (data.penunjang_lain) html += row('Penunjang Lain', data.penunjang_lain);
                        html += '</table></div>';
                    }
            ...
            // === RENDER PENILAIAN MEDIS KULIT & KELAMIN ===
            function renderPenilaianKulitDanKelamin() {
                const data = kulitdankelamin.data || kulitdankelamin || {};
                if (hasKeys(data, ['keluhan_utama', 'diagnosis'])) {
                    let html = '';
                    ...
                    if (data.kepala || data.thoraks || data.abdomen || data.ekstremitas || data.genetalia || data.columna || data.muskulos) {
                        html += '<div style="margin-bottom:20px; border:1px solid #e5e7eb; border-radius:8px; padding:12px; background:#f9fafb;">';
                        html += '<div style="font-size:12px; font-weight:700; margin-bottom:10px; color:#6366f1;"><i class="fa fa-user-md"></i> Pemeriksaan Organ</div>';
                        html += '<div style="display:grid; grid-template-columns: repeat(2, 1fr); gap:12px; font-size:12px;">';
                        html += '<div>';
                        if (data.kepala) html += '<div style="margin-bottom:6px;"><b>Kepala:</b> ' + escHtml(data.kepala) + '</div>';
                        if (data.thoraks) html += '<div style="margin-bottom:6px;"><b>Thoraks:</b> ' + escHtml(data.thoraks) + '</div>';
                        ...
                        html += '</div><div>';
                        if (data.genetalia) html += '<div style="margin-bottom:6px;"><b>Genetalia:</b> ' + escHtml(data.genetalia) + '</div>';
                        if (data.columna) html += '<div style="margin-bottom:6px;"><b>Columna:</b> ' + escHtml(data.columna) + '</div>';
                        if (data.muskulos) html += '<div style="margin-bottom:6px;"><b>Muskulos:</b> ' + escHtml(data.muskulos) + '</div>';
                        if (data.lainnya) html += '<div style="margin-bottom:6px;"><b>Lainnya:</b> ' + escHtml(data.lainnya) + '</div>';
                        html += '</div></div></div>';
                    }
                    ...
                    html += '<div style="margin-bottom:20px;">';
                    html += '<h5 style="font-size:12px !important; font-weight:700 !important; color:#f44336 !important; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #f44336; display:inline-block; padding-bottom:4px;">';
                    html += '<i class="fa fa-stethoscope"></i> V. Diagnosis & Perencanaan</h5>';
                    html += '<div style="background:#f6f9fc; border-left:4px solid #f44336; padding:12px; border-radius:4px; margin-bottom:8px;">';
                    html += '<div style="font-size:11px; color:#f44336; font-weight:700; text-transform:uppercase; margin-bottom:4px;">Diagnosis Utama</div>';
                    html += '<div style="font-size:14px; font-weight:600; color:#32325d;">' + escHtml(data.diagnosis || '-') + '</div>';
                    if (data.diagnosis2) {
                        html += '<hr style="border-top:1px dashed #fcd34d; margin:8px 0;"><div style="font-size:11px; color:#888;"><b>Diagnosis Banding:</b> ' + escHtml(data.diagnosis2) + '</div>';
                    }
                    if (data.permasalahan) {
                        html += '<hr style="border-top:1px dashed #fcd34d; margin:8px 0;"><div style="font-size:11px; color:#888;"><b>Permasalahan:</b> ' + escHtml(data.permasalahan) + '</div>';
                    }
                    ...
                    cardsToShow.push(cardWrap('kulitdankelamin', 'Asesmen Awal Medis Kulit & Kelamin (Dermatologi)', html));
                }
            }
            ...
            // === RENDER PENILAIAN MEDIS UMUM ===
            function renderAsesmenUmum() {
                const u = umum.data || umum || {};

                // Cek data (minimal anamnesis, fisik, atau diagnosis)
                if (!hasKeys(u, ['keluhan_utama', 'diagnosis', 'rps', 'ket_fisik', 'tht'])) return;

                const fisikRow = (lbl, val) => '<tr><td style="width:150px;color:#525f7f;padding:6px 0;font-weight:600;">' + escHtml(lbl) + '</td><td style="padding:6px 0 6px 15px;color:#32325d;">' + escHtml(val || '-') + '</td></tr>';
                const ttvItem = (lbl, val, unit) => '<div style="text-align:center;border:1px solid #e9ecef;padding:8px;border-radius:4px;background:#f8f9fa;"><div style="font-size:10px;color:#8898aa;text-transform:uppercase;margin-bottom:3px;">' + lbl + '</div><div style="font-weight:700;color:#32325d;font-size:15px;">' + escHtml(val || '-') + ' <small style="font-weight:400;color:#888;">' + unit + '</small></div></div>';
                const row = (lbl, val) => '<tr><td style="width:150px;color:#525f7f;padding:8px 0;vertical-align:top;border-bottom:1px solid #f6f9fc;font-weight:600;">' + escHtml(lbl) + '</td><td style="padding:8px 0 8px 15px;vertical-align:top;color:#32325d;border-bottom:1px solid #f6f9fc;line-height:1.6;">' + escHtml(val || '-') + '</td></tr>';

                // LAYOUT 1 KOLOM PENUH (VERTICAL)
                let html = '<div style="max-width:100%;">';

                // 1. ANAMNESIS
                html += '<div style="margin-bottom:24px;">' +
                    '<h5 style="font-size:13px;font-weight:700;color:#5e72e4;text-transform:uppercase;border-bottom:2px solid #5e72e4;padding-bottom:6px;display:inline-block;margin-bottom:12px;">' +
                    '<i class="fa fa-history"></i> Anamnesis' +
                    '</h5>' +
                    '<table style="width:100%;font-size:13px;border-collapse:collapse;">' +
                    row('Keluhan Utama', u.keluhan_utama) +
                    row('RPS', u.rps) +
                    row('RPD', u.rpd) +
                    row('RPK', u.rpk) +
                    row('RPO', u.rpo) +
                ...
                // 2. TANDA VITAL
                html += '<div style="margin-bottom:24px;">' +
                    '<h5 style="font-size:13px;font-weight:700;color:#2dce89;text-transform:uppercase;border-bottom:2px solid #2dce89;padding-bottom:6px;display:inline-block;margin-bottom:12px;">' +
                    '<i class="fa fa-heartbeat"></i> Tanda Vital' +
                    '</h5>' +
                    '<div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(120px, 1fr));gap:10px;margin-bottom:12px;">' +
                    ttvItem('TD', u.td, 'mmHg') +
                    ttvItem('Nadi', u.nadi, 'x/m') +
                    ttvItem('RR', u.rr, 'x/m') +
                    ttvItem('Suhu', u.suhu, '°C') +
                    ttvItem('SpO2', u.spo, '%') +
                    ttvItem('BB', u.bb, 'Kg') +
                    ttvItem('TB', u.tb, 'cm') +
                    '</div>' +
                    '<div style="background:#f8f9fa;padding:10px;border-radius:6px;font-size:13px;border-left:3px solid #2dce89;">' +
                    '<b>Kesadaran:</b> ' + escHtml(u.kesadaran || '-') + ' &nbsp;|&nbsp; <b>GCS:</b> ' + escHtml(u.gcs || '-') +
                    '</div>' +
                    '</div>';

                // 3. PEMERIKSAAN FISIK
                html += '<div style="margin-bottom:24px;">' +
                    '<h5 style="font-size:13px;font-weight:700;color:#11cdef;text-transform:uppercase;border-bottom:2px solid #11cdef;padding-bottom:6px;display:inline-block;margin-bottom:12px;">' +
                    '<i class="fa fa-user-md"></i> Pemeriksaan Fisik' +
                    '</h5>' +
                    '<table style="width:100%;font-size:13px;border-collapse:collapse;">' +
                    fisikRow('Kepala', u.kepala) +
                    fisikRow('Gigi & Mulut', u.gigi) +
                    fisikRow('THT', u.tht) +
                    fisikRow('Thoraks', u.thoraks) +
                    fisikRow('Abdomen', u.abdomen) +
                    fisikRow('Genital', u.genital) +
                    fisikRow('Ekstremitas', u.ekstremitas) +
                    fisikRow('Kulit', u.kulit) +
                    '</table>';

                if (u.ket_fisik) {
                    html += '<div style="margin-top:10px;background:#f6f9fc;padding:10px;border-radius:6px;font-size:13px;border-left:3px solid #11cdef;">' +
                        '<strong>Keterangan Fisik Lain:</strong><br>' + escHtml(u.ket_fisik) +
                        '</div>';
                }
                html += '</div>';

                // 4. STATUS LOKALIS (jika ada)
                if (u.lokalis_url) {
                    html += '<div style="margin-bottom:24px;">' +
                        '<h5 style="font-size:13px;font-weight:700;color:#fb6340;text-transform:uppercase;border-bottom:2px solid #fb6340;padding-bottom:6px;display:inline-block;margin-bottom:12px;">' +
                        '<i class="fa fa-male"></i> Status Lokalis' +
                        '</h5>' +
                        '<div style="text-align:center;border:1px solid #e9ecef;padding:15px;border-radius:8px;background:#fff;margin-bottom:10px;">' +
                        '<img src="' + u.lokalis_url + '" style="max-width:100%;max-height:300px;border-radius:4px;">' +
                        '</div>';

                    if (u.ket_lokalis) {
                        html += '<div style="background:#fff5f5;padding:10px;border-radius:6px;border-left:3px solid #fb6340;font-size:13px;color:#525f7f;">' +
                            escHtml(u.ket_lokalis) +
                            '</div>';
                    }
                    html += '</div>';
                }
                ...
                if (u.penunjang) {
                    html += '<div style="margin-bottom:24px;">' +
                        ...
                        '<i class="fa fa-flask"></i> Pemeriksaan Penunjang' +
                        '</h5>' +
                        '<div style="background:#f4f5f7;padding:12px;border-radius:6px;font-size:13px;line-height:1.6;border-left:3px solid #5e72e4;">' +
                        escHtml(u.penunjang).replace(/\n/g, '<br>') +
                        '</div>' +
                        '</div>';
                }

                // 6. DIAGNOSIS & TATALAKSANA
                html += '<div style="margin-bottom:24px;">' +
                    '<h5 style="font-size:13px;font-weight:700;color:#f5365c;text-transform:uppercase;border-bottom:2px solid #f5365c;padding-bottom:6px;display:inline-block;margin-bottom:12px;">' +
                    '<i class="fa fa-stethoscope"></i> Diagnosis & Tatalaksana' +
                    '</h5>' +
                    '<div style="background:#fff0f3;border:1px solid #fecdd3;border-radius:6px;padding:14px;margin-bottom:12px;">' +
                    '<div style="font-size:11px;font-weight:700;color:#e11d48;text-transform:uppercase;margin-bottom:6px;">Diagnosis</div>' +
                    '<div style="font-size:15px;font-weight:700;color:#881337;">' + escHtml(u.diagnosis || '-') + '</div>' +
                    '</div>' +
                    '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;padding:14px;margin-bottom:12px;">' +
                    '<div style="font-size:11px;font-weight:700;color:#16a34a;text-transform:uppercase;margin-bottom:6px;">Tatalaksana</div>' +
                    '<div style="font-size:13px;color:#14532d;line-height:1.6;">' + escHtml(u.tata || '-') + '</div>' +
                    '</div>';

                if (u.konsulrujuk) {
                    html += '<div style="background:#fffbeb;border:1px solid #fde68a;border-radius:6px;padding:14px;">' +
                        '<div style="font-size:11px;font-weight:700;color:#d97706;text-transform:uppercase;margin-bottom:6px;">Konsul / Rujuk</div>' +
                        '<div style="font-size:13px;color:#b45309;line-height:1.6;">' + escHtml(u.konsulrujuk) + '</div>' +
                        '</div>';
                }

                html += '</div></div>'; // End sections and wrapper

                // Tambahkan timestamp jika ada
                let footer = '';
                if (u.tanggal) {
                    footer = '<div style="margin-top:10px;padding-top:10px;border-top:1px solid #e9ecef;font-size:12px;color:#8898aa;">' +
                        '<i class="fa fa-clock-o"></i> ' + escHtml(u.tanggal) +
                        '</div>';
                }

                cardsToShow.push(cardWrap('umum', 'Asesmen Awal Medis Umum', html + footer));
            }
            ...
            // === 7b. RENDER PSIKIATRIK (COMPLETE & PREMIUM - STACKED LAYOUT) ===
            function renderPsikiatrik() {
                ...
                <div style="margin-bottom:24px;">
                    ...
                    <!-- 1. Info Dasar -->
                    <div style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:8px; padding:12px; margin-bottom:12px; display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                        ${row('Jenis Anamnesis', d.anamnesis)}
                        ${row('Hubungan', d.hubungan)}
                    </div>

                    <!-- 2. Keluhan Utama -->
                    <div style="background:${bgColor}; border-left:4px solid ${themeColor}; padding:16px; border-radius:4px; margin-bottom:12px;">
                        <div style="font-size:11px; font-weight:700; color:${themeColor}; text-transform:uppercase; margin-bottom:6px;">Keluhan Utama</div>
                        <div style="font-size:15px; font-weight:600; color:#1e293b; line-height:1.5;">${escHtml(d.keluhan_utama)}</div>
                    </div>
                     
                    <!-- 3. RPS -->
                    <div style="background:#fff; border:1px solid #e2e8f0; padding:16px; border-radius:8px; margin-bottom:12px; box-shadow:0 1px 2px rgba(0,0,0,0.05);">
                        <div style="font-size:11px; font-weight:700; color:#475569; text-transform:uppercase; margin-bottom:6px; border-bottom:1px dashed #cbd5e1; padding-bottom:4px;">Riwayat Penyakit Sekarang (RPS)</div>
                        <div style="font-size:13px; color:#334155; line-height:1.6; white-space:pre-wrap;">${escHtml(d.rps || '-')}</div>
                    </div>

                    <!-- 4. Riwayat Lain (Grid) -->
                    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap:12px;">
                         <div style="background:#f9fafb; padding:12px; border-radius:6px; border:1px solid #f1f5f9;">${row('RPD (Dahulu)', d.rpd)}</div>
                         <div style="background:#f9fafb; padding:12px; border-radius:6px; border:1px solid #f1f5f9;">${row('RPK (Keluarga)', d.rpk)}</div>
                         <div style="background:#f9fafb; padding:12px; border-radius:6px; border:1px solid #f1f5f9;">${row('RPO (Pengobatan)', d.rpo)}</div>
                         <div style="background:#fef2f2; padding:12px; border-radius:6px; border:1px solid #fee2e2;">
                             <span style="color:#ef4444; font-weight:700; font-size:11px; text-transform:uppercase; display:block; margin-bottom:4px;">Alergi</span>
                             <div style="font-weight:600; color:#b91c1c; font-size:13px;">${escHtml(d.alergi || 'Tidak ada')}</div>
                         </div>
                    </div>
                </div>`;
                ...
                <div>
                    ...
                    <div style="background:#f5f3ff; border-left:4px solid #7c3aed; padding:20px; border-radius:8px; margin-bottom:12px; border:1px solid #e9d5ff;">
                        <div style="margin-bottom:20px; border-bottom:1px dashed #ddd6fe; padding-bottom:16px;">
                             <div style="font-size:12px; font-weight:700; color:#7c3aed; text-transform:uppercase; margin-bottom:8px;">Diagnosis Psikiatri</div>
                             <div style="font-size:16px; font-weight:700; color:#1e293b; line-height:1.5;">${escHtml(d.diagnosis || '-')}</div>
                        </div>

                        <div style="margin-bottom:20px;">
                            <div style="font-size:12px; font-weight:700; color:#4b5563; text-transform:uppercase; margin-bottom:8px;">Tatalaksana / Terapi</div>
                            <div style="font-size:14px; color:#334155; line-height:1.7; white-space:pre-wrap; background:#fff; padding:12px; border-radius:6px; border:1px solid #e5e7eb;">${escHtml(d.tata || '-')}</div>
                        </div>
                        
                        ${d.konsulrujuk ? `
                        <div>
                            <div style="font-size:12px; font-weight:700; color:#dc2626; text-transform:uppercase; margin-bottom:8px;">Konsul / Rujuk</div>
                            <div style="font-size:14px; color:#b91c1c; font-weight:600; background:#fef2f2; padding:12px; border-radius:6px; border:1px solid #fee2e2;">${escHtml(d.konsulrujuk)}</div>
                        </div>` : ''}
                    </div>
                </div>`;
            ...
            // === 7b. RENDER ASESMEN GAWAT DARURAT PSIKIATRI ===
            function renderAsesmenGawatDaruratPsikiatri() {
                const d = igdPsikiatri.data || igdPsikiatri || {};
                if (!d || !d.no_rawat) return; // Basic check only

                // Theme: Blue (Standard)
                // const themeColor = '#1e40af'; 
                // Using standard blue header class.

                const row = (lbl, val) => `
                    <tr>
                        <td style="width:35%; padding:4px; color:#64748b; font-size:12px; border-bottom:1px solid #f1f5f9;">${lbl}</td>
                        <td style="width:65%; padding:4px; font-weight:600; color:#334155; font-size:12px; border-bottom:1px solid #f1f5f9;">${val || '-'}</td>
                    </tr>`;

                const gridItem = (lbl, val) => `
                    <div style="background:#fff; border:1px solid #e2e8f0; border-radius:6px; padding:8px;">
                         <div style="font-size:11px; color:#64748b; margin-bottom:2px;">${lbl}</div>
                         <div style="font-weight:600; color:#1e293b; font-size:13px;">${val || '-'}</div>
                    </div>`;

                const ttvItem = (lbl, val, unit) => `
                    <div style="text-align:center; padding:8px; background:#f8fafc; border-radius:8px; border:1px solid #e2e8f0;">
                        <div style="font-size:11px; font-weight:600; color:#64748b; text-transform:uppercase; margin-bottom:4px;">${lbl}</div>
                        <div style="font-size:14px; font-weight:700; color:#0ea5e9;">${val || '-'} <span style="font-size:10px; color:#94a3b8; font-weight:normal;">${unit}</span></div>
                    </div>`;

                let html = `<div style="font-family:'Inter', sans-serif;">`;

                // 1. ANAMNESIS (Single Column)
                html += `
                <div style="margin-bottom:24px;">
                     <h5 style="font-size:12px; font-weight:700; color:#1e40af; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #1e40af; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-history"></i> Anamnesis & Keluhan (IGD)
                    </h5>
                    
                    <div style="background:#eff6ff; border-left:4px solid #1e40af; padding:12px; border-radius:4px; margin-bottom:12px;">
                        <div style="font-weight:bold; color:#1e3a8a; font-size:13px;">Keluhan Utama</div>
                        <div style="font-size:13px; color:#1e293b; margin-top:4px;">${escHtml(d.keluhan_utama)}</div>
                    </div>

                    <table style="width:100%; border-collapse:collapse;">
                        ${d.anamnesis === 'Alloanamnesis' ? row('Hubungan dengan Pasien', escHtml(d.hubungan)) : ''}
                        ${row('Gejala Menyertai', escHtml(d.gejala_menyertai))}
                        ${row('Faktor Pencetus', escHtml(d.faktor_pencetus))}
                        ${row('Riwayat Penyakit Dahulu', `${escHtml(d.riwayat_penyakit_dahulu)} ${d.keterangan_riwayat_penyakit_dahulu ? '(' + escHtml(d.keterangan_riwayat_penyakit_dahulu) + ')' : ''}`)}
                        ${row('Riwayat Kehamilan', escHtml(d.riwayat_kehamilan))}
                        ${row('Riwayat Sosial & Pekerjaan', `Sosial: ${escHtml(d.riwayat_sosial)}<br>Pekerjaan: ${escHtml(d.riwayat_pekerjaan)}`)}
                        ${row('Riwayat Obat', escHtml(d.riwayat_obat_diminum))}
                        ${row('Kepribadian Premorbid', escHtml(d.faktor_kepribadian_premorbid))}
                        ${row('Faktor Keturunan', `${escHtml(d.faktor_keturunan)} ${d.keterangan_faktor_keturunan ? '(' + escHtml(d.keterangan_faktor_keturunan) + ')' : ''}`)}
                        ${row('Faktor Organik', `${escHtml(d.faktor_organik)} ${d.keterangan_faktor_organik ? '(' + escHtml(d.keterangan_faktor_organik) + ')' : ''}`)}
                         ${d.riwayat_alergi ? `
                            <tr>
                                <td style="width:35%; padding:4px; color:#ef4444; font-weight:bold; font-size:12px; border-bottom:1px solid #f1f5f9;">Riwayat Alergi</td>
                                <td style="width:65%; padding:4px; font-weight:bold; color:#dc2626; font-size:12px; border-bottom:1px solid #f1f5f9;">${escHtml(d.riwayat_alergi)}</td>
                            </tr>` : ''}
                    </table>
                </div>`;

                // 2. PEMERIKSAAN FISIK & TTV (Grid ttv, Table Kelainan)
                html += `
                <div style="margin-bottom:24px;">
                    <h5 style="font-size:12px; font-weight:700; color:#059669; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #059669; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-stethoscope"></i> Status Fisik & Sistemik
                    ...
                    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(80px, 1fr)); gap:8px; margin-bottom:16px;">
                        ${ttvItem('Kesadaran', d.fisik_kesadaran, '')}
                        ${ttvItem('GCS', d.fisik_gcs, '')}
                        ${ttvItem('TD', d.fisik_td, 'mmHg')}
                        ${ttvItem('Nadi', d.fisik_nadi, 'x/mnt')}
                        ${ttvItem('RR', d.fisik_rr, 'x/mnt')}
                        ${ttvItem('Suhu', d.fisik_suhu, '°C')}
                        ${ttvItem('BB', d.fisik_bb, 'kg')}
                        ${ttvItem('TB', d.fisik_tb, 'cm')}
                    </div>
                    
                    <div style="margin-bottom:12px;"><strong>Nyeri:</strong> ${escHtml(d.fisik_nyeri)} | <strong>Nutrisi:</strong> ${escHtml(d.fisik_status_nutrisi)}</div>

                    <div style="font-weight:600; color:#334155; margin-bottom:8px; font-size:12px; border-bottom:1px solid #cbd5e1; padding-bottom:4px;">Status Kelainan Head To Toe</div>
                    <table style="width:100%; border-collapse:collapse; font-size:12px;">
                        ${['kepala', 'leher', 'dada', 'perut', 'anggota_gerak'].map(k => {
                    const st = d['status_kelainan_' + k];
                    const note = d['keterangan_status_kelainan_' + k];
                    const isAbnormal = st && st.toLowerCase() !== 'normal' && st.toLowerCase() !== 'tidak ada kelainan';
                    const styleVal = isAbnormal ? 'color:#dc2626; font-weight:bold;' : 'color:#334155;';
                    return `
                            <tr>
                                <td style="padding:4px; width:30%; border-bottom:1px solid #f1f5f9; color:#64748b; text-transform:capitalize;">${k.replace('_', ' ')}</td>
                                <td style="padding:4px; border-bottom:1px solid #f1f5f9; ${styleVal}">${escHtml(st || '-')} ${note ? `(${escHtml(note)})` : ''}</td>
                            </tr>`;
                }).join('')}
                    </table>
                </div>`;
                ...
                // 3. STATUS LOKALISATA
                if (d.status_lokalisata || d.lokalis_url) {
                    html += `
                    <div style="margin-bottom:24px;">
                        <h5 style="font-size:12px; font-weight:700; color:#d97706; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #d97706; display:inline-block; padding-bottom:4px;">
                            <i class="fa fa-crosshairs"></i> Status Lokalisata
                        </h5>
                        ${d.status_lokalisata ? `<div style="margin-bottom:8px; font-size:13px; color:#334155;">${escHtml(d.status_lokalisata)}</div>` : ''}
                        ${d.lokalis_url ? `
                        <div style="text-align:center; padding:10px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:8px;">
                            <img src="${d.lokalis_url}" style="max-width:100%; max-height:300px; border:1px solid #cbd5e1; border-radius:4px;" alt="Lokalisata">
                        </div>` : ''}
                    </div>`;
                }

                // 4. STATUS PSIKIATRIK (Grid)
                html += `
                <div style="margin-bottom:24px;">
                    <h5 style="font-size:12px; font-weight:700; color:#db2777; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #db2777; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-brain"></i> Status Psikiatrik
                    </h5>
                    <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
                        ${gridItem('Kesan Umum', d.psikiatrik_kesan_umum)}
                        ${gridItem('Sikap & Prilaku', d.psikiatrik_sikap_prilaku)}
                        ${gridItem('Kesadaran', d.psikiatrik_kesadaran)}
                        ${gridItem('Orientasi', d.psikiatrik_orientasi)}
                        ${gridItem('Daya Ingat', d.psikiatrik_daya_ingat)}
                        ${gridItem('Persepsi', d.psikiatrik_persepsi)}
                        ${gridItem('Pikiran', d.psikiatrik_pikiran)}
                        ${gridItem('Insight', d.psikiatrik_insight)}
                    </div>
                </div>`;

                // 5. PENUNJANG (Lab, Rad, EKG)
                if (hasAny({ l: d.laborat, r: d.radiologi, e: d.ekg })) {
                    html += `
                    <div style="margin-bottom:24px;">
                        <h5 style="font-size:12px; font-weight:700; color:#7c3aed; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #7c3aed; display:inline-block; padding-bottom:4px;">
                             <i class="fa fa-flask"></i> Pemeriksaan Penunjang (IGD)
                        </h5>
                         <table style="width:100%; border-collapse:collapse;">
                            ${d.laborat ? row('Laboratorium', escHtml(d.laborat)) : ''}
                            ${d.radiologi ? row('Radiologi', escHtml(d.radiologi)) : ''}
                            ${d.ekg ? row('EKG', escHtml(d.ekg)) : ''}
                         </table>
                    </div>`;
                }
                ...
                html += `
                <div style="margin-bottom:24px;">
                     <h5 style="font-size:12px; font-weight:700; color:#dc2626; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #dc2626; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-user-md"></i> Diagnosis & Tatalaksana
                    </h5>

                    <div style="background:#fef2f2; border-left:4px solid #dc2626; padding:16px; border-radius:8px; margin-bottom:12px; border:1px solid #fee2e2;">
                        <div style="font-size:11px; font-weight:700; color:#b91c1c; text-transform:uppercase; margin-bottom:4px;">Diagnosis</div>
                        <div style="font-size:15px; font-weight:700; color:#1e293b; margin-bottom:12px;">${escHtml(d.diagnosis)}</div>

                        ${d.permasalahan ? `
                        <div style="margin-top:12px; border-top:1px dashed #fecaca; padding-top:8px;">
                            <div style="font-size:11px; font-weight:700; color:#b91c1c;">Permasalahan</div>
                            <div style="font-size:13px; color:#334155;">${escHtml(d.permasalahan)}</div>
                        </div>` : ''}
                    </div>

                    <table style="width:100%; border-collapse:collapse;">
                        ${row('Instruksi Medis', escHtml(d.instruksi_medis))}
                        ${row('Rencana / Target', escHtml(d.rencana_target))}
                        ${row('Edukasi', escHtml(d.edukasi))}
                    </table>
                </div>`;

                // 7. KELUAR IGD & KONDISI PULANG
                html += `
                <div>
                     <h5 style="font-size:12px; font-weight:700; color:#475569; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #475569; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-sign-out-alt"></i> Keluar IGD & Kondisi Pulang
                    </h5>
                    
                    <div style="margin-bottom:12px; font-size:12px;">
                        <strong>Status Pulang:</strong> 
                        ${d.pulang_dipulangkan === 'Ya' ? 'Dipulangkan (' + escHtml(d.keterangan_pulang_dipulangkan) + ')' : ''}
                        ${d.pulang_paksa === 'Ya' ? 'Pulang Paksa (' + escHtml(d.keterangan_pulang_paksa) + ')' : ''}
                        ${d.pulang_dirawat_diruang === 'Ya' ? 'Dirawat (' + escHtml(d.pulang_indikasi_ranap) + ')' : ''}
                        ${d.pulang_dirujuk_ke ? 'Dirujuk ke ' + escHtml(d.pulang_dirujuk_ke) : ''}
                        ${d.pulang_meninggal_igd === 'Ya' ? 'Meninggal' : ''}
                    </div>

                     <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(60px, 1fr)); gap:4px; font-size:11px; background:#f8fafc; padding:8px; border-radius:6px; border:1px solid #e2e8f0;">
                        <div style="text-align:center;"><strong>Kesadaran</strong><br>${d.fisik_pulang_kesadaran || '-'}</div>
                        <div style="text-align:center;"><strong>GCS</strong><br>${d.fisik_pulang_gcs || '-'}</div>
                        <div style="text-align:center;"><strong>TD</strong><br>${d.fisik_pulang_td || '-'}</div>
                        <div style="text-align:center;"><strong>Nadi</strong><br>${d.fisik_pulang_nadi || '-'}</div>
                        <div style="text-align:center;"><strong>Suhu</strong><br>${d.fisik_pulang_suhu || '-'}</div>
                        <div style="text-align:center;"><strong>RR</strong><br>${d.fisik_pulang_rr || '-'}</div>
                    </div>
                </div>`;

                html += `</div>`; // End main div

                cardsToShow.push(cardWrap('igd_psikiatri', 'Asesmen Gawat Darurat Psikiatri', html));
            }
            renderAsesmenGawatDaruratPsikiatri();

            // === 7c. RENDER ASESMEN GERIATRI ===
            function renderAsesmenGeriatri() {
                const d = geriatri.data || geriatri || {};
                if (!d || !d.no_rawat) return; // Basic check only
                ...
                const ttvItem = (lbl, val, unit) => `
                    <div style="text-align:center; padding:8px; background:#f8fafc; border-radius:8px; border:1px solid #e2e8f0;">
                        <div style="font-size:11px; font-weight:600; color:#64748b; text-transform:uppercase; margin-bottom:4px;">${lbl}</div>
                        <div style="font-size:14px; font-weight:700; color:#0d9488;">${val || '-'} <span style="font-size:10px; color:#94a3b8; font-weight:normal;">${unit}</span></div>
                    </div>`;

                const gridBox = (lbl, val) => `
                    <div style="background:#fff; border:1px solid #e2e8f0; border-radius:6px; padding:10px;">
                         <div style="font-size:11px; color:#64748b; margin-bottom:4px; text-transform:uppercase; font-weight:bold;">${lbl}</div>
                         <div style="font-weight:600; color:#1e293b; font-size:13px;">${val || '-'}</div>
                    </div>`;
                ...
                html += `
                <div style="margin-bottom:24px;">
                     <h5 style="font-size:12px; font-weight:700; color:#0d9488; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #0d9488; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-history"></i> Anamnesis
                    </h5>
                    
                    <div style="background:#f0fdfa; border-left:4px solid #0d9488; padding:12px; border-radius:4px; margin-bottom:12px;">
                        <div style="font-weight:bold; color:#115e59; font-size:13px;">Keluhan Utama</div>
                        <div style="font-size:13px; color:#1e293b; margin-top:4px;">${escHtml(d.keluhan_utama)}</div>
                    </div>

                    <table style="width:100%; border-collapse:collapse;">
                        ${d.anamnesis === 'Alloanamnesis' ? row('Hubungan dengan Pasien', escHtml(d.hubungan)) : ''}
                        ${row('Riwayat Penyakit Sekarang', escHtml(d.rps))}
                        ${row('Riwayat Penyakit Dahulu', escHtml(d.rpd))}
                        ${row('Riwayat Penggunaan Obat', escHtml(d.rpo))}
                        ${row('Riwayat Alergi', escHtml(d.alergi))}
                    </table>
                </div>`;
                ...
                <div style="margin-bottom:24px;">
                    <h5 style="font-size:12px; font-weight:700; color:#059669; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #059669; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-heartbeat"></i> Fisik & Tanda Vital
                    </h5>
                    
                    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(80px, 1fr)); gap:8px; margin-bottom:16px;">
                        ${ttvItem('TD', d.td, 'mmHg')}
                        ${ttvItem('Nadi', d.nadi, 'x/mnt')}
                        ${ttvItem('Suhu', d.suhu, '°C')}
                        ${ttvItem('RR', d.rr, 'x/mnt')}
                    </div>

                    ${(d.kondisi_umum || d.tulang_belakang) ? `
                    <div style="margin-bottom:12px; padding:10px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:6px; font-size:12px;">
                        ${d.kondisi_umum ? `<div><strong>Kondisi Umum:</strong> ${escHtml(d.kondisi_umum)}</div>` : ''}
                        ${d.tulang_belakang ? `<div style="margin-top:4px;"><strong>Tulang Belakang:</strong> ${escHtml(d.tulang_belakang)}</div>` : ''}
                    </div>` : ''}
                </div>`;

                // 3. PENGKAJIAN KHUSUS GERIATRI (Grid Layout)
                html += `
                <div style="margin-bottom:24px;">
                    <h5 style="font-size:12px; font-weight:700; color:#d97706; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #d97706; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-blind"></i> Pengkajian Geriatri
                    </h5>
                    
                    <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:12px; margin-bottom:16px;">
                        ${gridBox('Psikologis (GDS)', d.status_psikologis_gds)}
                        ${gridBox('Kognitif (MMSE)', d.status_kognitif_mmse)}
                        ${gridBox('Fungsional', d.status_fungsional)}
                        ${gridBox('Nutrisi', d.status_nutrisi)}
                        ${gridBox('Risiko Jatuh', d.skrining_jatuh)}
                    </div>
                    
                    ${d.kondisi_sosial ? `
                    <div style="margin-bottom:12px; background:#fff7ed; padding:12px; border-radius:6px; border:1px solid #ffedd5;">
                        <div style="font-size:11px; font-weight:700; color:#c2410c; text-transform:uppercase; margin-bottom:4px;">Kondisi Sosial</div>
                        <div style="font-size:13px; color:#431407;">${escHtml(d.kondisi_sosial)}</div>
                    </div>` : ''}
                </div>`;

                // 4. PEMERIKSAAN SISTEMIK & INTEGUMENT
                html += `
                <div style="margin-bottom:24px;">
                    <h5 style="font-size:12px; font-weight:700; color:#4b5563; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #4b5563; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-user-md"></i> Status Sistemik & Integument
                    </h5>
                    
                    <table style="width:100%; border-collapse:collapse; font-size:12px; margin-bottom:16px;">
                        ${['kepala', 'thoraks', 'abdomen', 'ekstremitas'].map(k => {
                    const val = d[k];
                    const ket = d['keterangan_' + k];
                    if (!val && !ket) return '';
                    return `
                            <tr>
                                <td style="padding:6px; width:30%; border-bottom:1px solid #f1f5f9; color:#64748b; text-transform:capitalize; font-weight:600;">${k}</td>
                                <td style="padding:6px; border-bottom:1px solid #f1f5f9; color:#334155;">
                                    ${escHtml(val || '-')} 
                                    ${ket ? `<div style="font-size:11px; color:#64748b; font-style:italic; margin-top:2px;">Ket: ${escHtml(ket)}</div>` : ''}
                                </td>
                            </tr>`;
                }).join('')}
                    </table>
                    ...
                    <div style="background:#f8fafc; padding:10px; border-radius:6px; border:1px solid #e2e8f0; font-size:12px;">
                        <div style="font-weight:700; color:#334155; margin-bottom:6px;">Integument (Kulit):</div>
                        <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:8px;">
                            <div><span style="color:#64748b;">Kebersihan:</span> ${escHtml(d.Integument_kebersihan || '-')}</div>
                            <div><span style="color:#64748b;">Warna:</span> ${escHtml(d.Integument_warna || '-')}</div>
                            <div><span style="color:#64748b;">Kelembaban:</span> ${escHtml(d.Integument_kelembaban || '-')}</div>
                            <div><span style="color:#64748b;">Gangguan:</span> ${escHtml(d.Integument_gangguan_kulit || '-')}</div>
                        </div>
                    </div>
                    
                     ${d.lainnya ? `
                    <div style="margin-top:12px;">
                        <div style="font-size:12px; font-weight:700; color:#334155; margin-bottom:4px;">Pemeriksaan Lainnya:</div>
                        <div style="font-size:13px; color:#475569; background:#fff; padding:8px; border:1px solid #e2e8f0; border-radius:4px;">${escHtml(d.lainnya)}</div>
                    </div>` : ''}
                </div>`;

                // 5. PENUNJANG
                if (hasAny({ l: d.lab, r: d.rad, p: d.pemeriksaan })) {
                    html += `
                    <div style="margin-bottom:24px;">
                        <h5 style="font-size:12px; font-weight:700; color:#7c3aed; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #7c3aed; display:inline-block; padding-bottom:4px;">
                             <i class="fa fa-flask"></i> Pemeriksaan Penunjang
                         ...
                         <table style="width:100%; border-collapse:collapse;">
                            ${d.lab ? row('Laboratorium', escHtml(d.lab)) : ''}
                            ${d.rad ? row('Radiologi', escHtml(d.rad)) : ''}
                            ${d.pemeriksaan ? row('Penunjang Lain', escHtml(d.pemeriksaan)) : ''}
                         </table>
                    </div>`;
                }
                ...
                html += `
                <div style="margin-bottom:24px;">
                     <h5 style="font-size:12px; font-weight:700; color:#b91c1c; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #b91c1c; display:inline-block; padding-bottom:4px;">
                        <i class="fa fa-stethoscope"></i> Diagnosis & Tatalaksana
                    </h5>

                    <div style="background:#fef2f2; border-left:4px solid #b91c1c; padding:16px; border-radius:8px; margin-bottom:12px; border:1px solid #fee2e2;">
                        <div style="font-size:11px; font-weight:700; color:#b91c1c; text-transform:uppercase; margin-bottom:4px;">Diagnosis Utama</div>
                        <div style="font-size:15px; font-weight:700; color:#1e293b; margin-bottom:8px;">${escHtml(d.diagnosis)}</div>
                        
                        ${d.diagnosis2 ? `
                        <div style="border-top:1px dashed #fecaca; padding-top:8px; margin-top:8px;">
                            <div style="font-size:11px; font-weight:700; color:#7f1d1d; margin-bottom:2px;">Diagnosis Sekunder</div>
                             <div style="font-size:13px; color:#334155;">${escHtml(d.diagnosis2)}</div>
                        </div>` : ''}

                         ${d.permasalahan ? `
                        <div style="border-top:1px dashed #fecaca; padding-top:8px; margin-top:8px;">
                            <div style="font-size:11px; font-weight:700; color:#7f1d1d; margin-bottom:2px;">Permasalahan</div>
                             <div style="font-size:13px; color:#334155;">${escHtml(d.permasalahan)}</div>
                        </div>` : ''}
                    </div>

                    <table style="width:100%; border-collapse:collapse;">
                        ${row('Terapi / Pengobatan', escHtml(d.terapi))}
                        ${row('Tindakan', escHtml(d.tindakan))}
                        ${row('Edukasi', escHtml(d.edukasi))}
                    </table>
                </div>`;
                ...
                cardsToShow.push(cardWrap('geriatri', 'Asesmen Awal Medis Geriatri', html));
            }
            renderAsesmenGeriatri();

            // === RENDER ASESMEN REHAB MEDIK ===
            function renderAsesmenRehabMedik() {
                const d = asesmenRehabMedik.data || asesmenRehabMedik || {};
                if (!d || !d.no_rawat) return;
                const dateFmt = (dStr) => {
                    if (!dStr || dStr === '0000-00-00') return '-';
                    const d = new Date(dStr);
                    if (isNaN(d.getTime())) return dStr;
                    return d.toLocaleDateString('id-ID'); // or 'en-GB' for dd/mm/yyyy
                };
                ...
                const row = (label, val) => `
                <tr >
                        <td style="width:140px; color:#525f7f; padding:5px 0; vertical-align:top; border-bottom:1px solid #f6f9fc; font-weight:600;">${escHtml(label)}</td>
                        <td style="padding:5px 0 5px 15px; vertical-align:top; color:#32325d; font-weight:500; border-bottom:1px solid #f6f9fc; line-height:1.5;">${escHtml(val || '-')}</td>
                    </tr > `;

                let html = `<div style="display:flex; flex-direction:column; gap:30px;">`;

                // 1. ANAMNESIS (Full Width)
                html += `
                    <div>
                         <h5 style="font-size:12px; font-weight:700; color:#1e40af; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #1e40af; display:inline-block; padding-bottom:4px;">
                            <i class="fa fa-history"></i> Anamnesis
                ...
                html += `
                    <div>
                        ...
                        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap:16px;">
                            ...
                            ${ttvBox('Suhu', d.suhu, '°C')}
                            ${ttvBox('BB', d.bb, 'Kg')}
                            ${ttvBox('Nyeri', d.skala_nyeri + ' - ' + d.nyeri)}
                            ${ttvBox('Kesadaran', d.kesadaran)}
                        </div>
                    </div>`;

                // 3. PEMERIKSAAN SISTEMIK (Full Width)
                html += `
                    <div>
                         <h5 style="font-size:12px; font-weight:700; color:#fb6340; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #fb6340; display:inline-block; padding-bottom:4px;">
                            <i class="fa fa-user-md"></i> Pemeriksaan Sistemik
                        </h5>
                        <table style="width:100%; font-size:13px; border-collapse:collapse; background:#fff;" class="table table-bordered">
                            <thead style="background:#f1f5f9;"><tr><th style="padding:8px; width:25%;">Sistem</th><th style="padding:8px; width:25%;">Status</th><th style="padding:8px;">Keterangan</th></tr></thead>
                            <tbody>
                                <tr><td style="padding:8px;">Kepala/Leher</td><td style="padding:8px;">${escHtml(d.kepala || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_kepala || '-')}</td></tr>
                                <tr><td style="padding:8px;">Thorak/Jantung/Paru</td><td style="padding:8px;">${escHtml(d.thoraks || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_thorak || '-')}</td></tr>
                                <tr><td style="padding:8px;">Abdomen</td><td style="padding:8px;">${escHtml(d.abdomen || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_abdomen || '-')}</td></tr>
                                <tr><td style="padding:8px;">Ekstremitas</td><td style="padding:8px;">${escHtml(d.ekstremitas || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_ekstremitas || '-')}</td></tr>
                                <tr><td style="padding:8px;">Columna Vertebralis</td><td style="padding:8px;">${escHtml(d.columna || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_columna || '-')}</td></tr>
                                <tr><td style="padding:8px;">Muskuloskeletal</td><td style="padding:8px;">${escHtml(d.muskulos || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_muskulos || '-')}</td></tr>
                            </tbody>
                        </table>
                         ${d.lainnya ? `<div style="margin-top:8px; font-style:italic; font-size:13px; color:#475569; background:#f8fafc; padding:10px; border-radius:6px; border:1px solid #e2e8f0;"><b>Catatan Lainnya:</b> ${escHtml(d.lainnya)}</div>` : ''}
                    </div>`;

                // 4. RISIKO & FUNGSIONAL (Full Width)
                html += `
                    <div>
                         <h5 style="font-size:12px; font-weight:700; color:#8b5cf6; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #8b5cf6; display:inline-block; padding-bottom:4px;">
                            <i class="fa fa-tasks"></i> Risiko & Fungsional
                        </h5>
                        <ul style="list-style:none; padding:0; margin:0; font-size:13px; background:#f8fafc; padding:16px; border-radius:8px; border:1px solid #e2e8f0;">
                            <li style="margin-bottom:12px; display:flex; border-bottom:1px dashed #e2e8f0; padding-bottom:8px;">
                                <span style="width:160px; font-weight:700; color:#525f7f;">Risiko Jatuh</span>
                                <span style="flex:1; color:#334155;">: ${escHtml(d.resiko_jatuh)}</span>
                            </li>
                            <li style="margin-bottom:12px; display:flex; border-bottom:1px dashed #e2e8f0; padding-bottom:8px;">
                                <span style="width:160px; font-weight:700; color:#525f7f;">Risiko Nutrisional</span>
                                <span style="flex:1; color:#334155;">: ${escHtml(d.resiko_nutrisional)}</span>
                            </li>
                            <li style="margin-bottom:4px; display:flex;">
                                <span style="width:160px; font-weight:700; color:#525f7f;">Kebutuhan Fungsional</span>
                                <span style="flex:1; color:#334155;">: ${escHtml(d.kebutuhan_fungsional)}</span>
                            </li>
                        </ul>
                    </div>`;
                ...
                html += `
                    <div>
                        ...
                        <div style="display:flex; flex-direction:column; gap:12px;">
                            <div style="background:#fef2f2; border-left:4px solid #b91c1c; padding:16px; border-radius:6px; border:1px solid #fee2e2;">
                                <div style="font-size:12px; font-weight:700; color:#b91c1c; margin-bottom:4px; text-transform:uppercase;">Diagnosa Medis</div>
                                <div style="font-size:14px; color:#1e293b; font-weight:600; line-height:1.5;">${escHtml(d.diagnosa_medis)}</div>
                            </div>
                            <div style="background:#fff1f2; border-left:4px solid #e11d48; padding:16px; border-radius:6px; border:1px solid #ffe4e6;">
                                <div style="font-size:12px; font-weight:700; color:#e11d48; margin-bottom:4px; text-transform:uppercase;">Diagnosa Fungsi</div>
                                <div style="font-size:14px; color:#1e293b; font-weight:600; line-height:1.5;">${escHtml(d.diagnosa_fungsi)}</div>
                            </div>
                        </div>
                    </div>`;

                // 6. PROGRAM TERAPI (Full Width)
                html += `
                    <div>
                            <h5 style="font-size:12px; font-weight:700; color:#0e7490; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #0e7490; display:inline-block; padding-bottom:4px;">
                                <i class="fa fa-medkit"></i> Program Terapi
                            </h5>
                            <div class="table-responsive">
                             <table style="width:100%; font-size:13px; border-collapse:collapse; background:#fff;" class="table table-bordered table-striped">
                                <thead style="background:#0e7490; color:white;"><tr><th style="padding:10px 12px; width:20%;">Jenis</th><th style="padding:10px 12px;">Tindakan</th><th style="padding:10px 12px; width:20%; text-align:center;">Rencana Tgl</th></tr></thead>
                                <tbody>
                                    <tr><td style="padding:10px 12px; font-weight:600;">Fisioterapi</td><td style="padding:10px 12px;">${escHtml(d.fisio)}</td><td style="padding:10px 12px; text-align:center;">${d.fisioterapi != '0000-00-00' ? dateFmt(d.fisioterapi) : '-'}</td></tr>
                                    <tr><td style="padding:10px 12px; font-weight:600;">Okupasi</td><td style="padding:10px 12px;">${escHtml(d.okupasi)}</td><td style="padding:10px 12px; text-align:center;">${d.terapi_okupasi != '0000-00-00' ? dateFmt(d.terapi_okupasi) : '-'}</td></tr>
                                    <tr><td style="padding:10px 12px; font-weight:600;">Wicara</td><td style="padding:10px 12px;">${escHtml(d.wicara)}</td><td style="padding:10px 12px; text-align:center;">${d.terapi_wicara != '0000-00-00' ? dateFmt(d.terapi_wicara) : '-'}</td></tr>
                                     <tr><td style="padding:10px 12px; font-weight:600;">Akupuntur</td><td style="padding:10px 12px;">${escHtml(d.akupuntur)}</td><td style="padding:10px 12px; text-align:center;">${d.terapi_akupuntur != '0000-00-00' ? dateFmt(d.terapi_akupuntur) : '-'}</td></tr>
                                     <tr><td style="padding:10px 12px; font-weight:600;">Lainnya</td><td style="padding:10px 12px;">${escHtml(d.tatalain)}</td><td style="padding:10px 12px; text-align:center;">${d.terapi_lainnya != '0000-00-00' ? dateFmt(d.terapi_lainnya) : '-'}</td></tr>
                                </tbody>
                            </table>
                            </div>
                             <div style="margin-top:16px; font-size:13px; display:flex; gap:20px; flex-wrap:wrap;">
                                <div style="background:#ecfeff; padding:10px 16px; border-radius:6px; border:1px solid #cffafe; color:#0e7490; display:flex; align-items:center; gap:8px;">
                                    <i class="fa fa-clock-o"></i> <b>Frekuensi:</b> ${escHtml(d.frekuensi_terapi)}
                                </div>
                                ${d.penunjang_lain ? `<div style="background:#fff7ed; padding:10px 16px; border-radius:6px; border:1px solid #ffedd5; color:#c2410c; display:flex; align-items:center; gap:8px;"><i class="fa fa-sticky-note-o"></i> <b>Penunjang lain:</b> ${escHtml(d.penunjang_lain)}</div>` : ''}
                             </div>
                        </div>`;

                // 7. EDUKASI (Full Width)
                if (d.edukasi) {
                    html += `
                        <div>
                            <div style="background:#f0fdf4; border:1px solid #bbf7d0; padding:16px; border-radius:8px;">
                                 <h6 style="font-size:12px; font-weight:700; color:#15803d; margin-top:0; margin-bottom:8px; display:flex; align-items:center; gap:6px;"><i class="fa fa-info-circle"></i> Edukasi</h6>
                                 <div style="font-size:14px; color:#166534; line-height:1.6;">${escHtml(d.edukasi)}</div>
                            </div>
                        </div>`;
                }
                ...
                cardsToShow.push(cardWrap('rehab', 'Asesmen Awal Medis Rehab Medik', html));
            }
            renderAsesmenRehabMedik();

            // === RENDER ASESMEN UROLOGI ===
            function renderAsesmenUrologi() {
                const d = asesmenUrologi.data || asesmenUrologi || {};
                if (!d || !d.no_rawat) return;
                ...
                html += `
                    <div>
                         <h5 style="font-size:12px; font-weight:700; color:#1e40af; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #1e40af; display:inline-block; padding-bottom:4px;">
                            <i class="fa fa-history"></i> Anamnesis (${escHtml(d.anamnesis)})
                        </h5>
                        <table style="width:100%; font-size:13px; border-collapse:collapse;">
                            ${d.anamnesis === 'Alloanamnesis' ? row('Hubungan', d.hubungan) : ''}
                            ${row('Keluhan Utama', d.keluhan_utama)}
                            ${row('RPS', d.rps)}
                            ${row('RPD', d.rpd)}
                            ${row('RPK', d.rpk)}
                            ${row('RPO', d.rpo)}
                             ${row('Riw. Kebiasaan', d.riwayat_kebiasaan)}
                            ${row('Riw. Op. Urologi', d.riwayat_operasi_urologi)}
                            ${row('Alergi', d.alergi)}
                        </table>
                    </div>`;
                ...
                html += `
                     <div>
                        ...
                        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap:16px; margin-bottom:16px;">
                            ...
                            ${ttvBox('BB', d.bb, 'Kg')}
                            ${ttvBox('TB', d.tb, 'cm')}
                            ${ttvBox('Nyeri', d.nyeri)}
                        </div>
                        <table style="width:100%; font-size:13px; border-collapse:collapse;">
                             ${row('Status Nutrisi', d.status_nutrisi)}
                             ${row('Keadaan Umum', d.keadaan_umum)}
                        </table>
                    </div>`;

                // 3. PEMERIKSAAN SISTEMIK & UROLOGI (Full Width)
                html += `
                    <div>
                         <h5 style="font-size:12px; font-weight:700; color:#fb6340; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #fb6340; display:inline-block; padding-bottom:4px;">
                            <i class="fa fa-user-md"></i> Pemeriksaan Fisik & Urologi
                        </h5>
                        
                        <div style="margin-bottom:16px;">
                            <h6 style="font-size:11px; font-weight:700; color:#475569; text-transform:uppercase; margin-bottom:8px;">Pemeriksaan Sistemik</h6>
                            <table style="width:100%; font-size:13px; border-collapse:collapse; background:#fff;" class="table table-bordered">
                                <thead style="background:#f1f5f9;"><tr><th style="padding:8px; width:20%;">Area</th><th style="padding:8px;">Hasil</th><th style="padding:8px;">Keterangan</th></tr></thead>
                                <tbody>
                                    <tr><td style="padding:8px;">Thoraks</td><td style="padding:8px;">${escHtml(d.thoraks || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_thoraks || '-')}</td></tr>
                                    <tr><td style="padding:8px;">Abdomen</td><td style="padding:8px;">${escHtml(d.abdomen || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_abdomen || '-')}</td></tr>
                                    <tr><td style="padding:8px;">Ekstremitas</td><td style="padding:8px;">${escHtml(d.ekstrimitas || '-')}</td><td style="padding:8px;">${escHtml(d.keterangan_ekstremitas || '-')}</td></tr>
                                </tbody>
                            </table>
                        </div>

                         <div style="margin-bottom:16px;">
                             <h6 style="font-size:11px; font-weight:700; color:#475569; text-transform:uppercase; margin-bottom:8px;">Pemeriksaan Urologi Khusus</h6>
                             <table style="width:100%; font-size:13px; border-collapse:collapse;">
                                ${row('Nyeri Ketok CVA', d.nyeri_ketok_cva)}
                                ${row('Genitalia Eksternal', d.genitalia_eksternal)}
                                ${row('Colok Dubur', d.colok_dubur)}
                             </table>
                        </div>

                        ${d.lainnya ? `<div style="margin-top:8px; font-style:italic; font-size:13px; color:#475569; background:#f8fafc; padding:10px; border-radius:6px; border:1px solid #e2e8f0;"><b>Pemeriksaan Lainnya:</b> ${escHtml(d.lainnya)}</div>` : ''}
                    </div>`;
                ...
                html += `
                    <div>
                        ...
                        <table style="width:100%; font-size:13px; border-collapse:collapse;">
                            ${row('Urinalisis', d.urinalisis)}
                            ${row('Darah', d.darah)}
                            ${row('USG Urologi', d.usg_urologi)}
                            ${row('Radiologi', d.radiologi)}
                            ${row('Penunjang Lain', d.penunjang_lain)}
                        </table>
                    </div>`;

                // 5. DIAGNOSIS & TATALAKSANA
                html += `
                    <div>
                          <h5 style="font-size:12px; font-weight:700; color:#b91c1c; text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; border-bottom:2px solid #b91c1c; display:inline-block; padding-bottom:4px;">
                            <i class="fa fa-stethoscope"></i> Diagnosis & Tatalaksana
                         ...
                         <div style="background:#fef2f2; border-left:4px solid #b91c1c; padding:16px; border-radius:6px; border:1px solid #fee2e2; margin-bottom:16px;">
                            <div style="font-size:12px; font-weight:700; color:#b91c1c; margin-bottom:4px; text-transform:uppercase;">Diagnosis Utama</div>
                            <div style="font-size:14px; color:#1e293b; font-weight:600; line-height:1.5;">${escHtml(d.diagnosis)}</div>
                             ${d.diagnosis2 ? `<div style="margin-top:8px; border-top:1px dashed #fecaca; padding-top:8px;"><div style="font-size:11px; font-weight:700; color:#991b1b; margin-bottom:2px; text-transform:uppercase;">Diagnosis Sekunder</div><div style="font-size:13px; color:#450a0a;">${escHtml(d.diagnosis2)}</div></div>` : ''}
                              ${d.permasalahan ? `<div style="margin-top:8px; border-top:1px dashed #fecaca; padding-top:8px;"><div style="font-size:11px; font-weight:700; color:#991b1b; margin-bottom:2px; text-transform:uppercase;">Permasalahan</div><div style="font-size:13px; color:#450a0a;">${escHtml(d.permasalahan)}</div></div>` : ''}
                        </div>

                        <table style="width:100%; font-size:13px; border-collapse:collapse;">
                            ${row('Terapi/Pengobatan', d.terapi)}
                            ${row('Tindakan', d.tindakan)}
                            ${row('Edukasi', d.edukasi)}
                        </table>
                    </div>`;
                ...
                cardsToShow.push(cardWrap('urologi', 'Asesmen Awal Medis Urologi', html));
            }
            renderAsesmenUrologi();
