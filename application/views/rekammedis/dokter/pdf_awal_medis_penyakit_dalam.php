...
<head>
    <title>Asesmen Awal Medis Penyakit Dalam</title>
    <style>
        body {
...
<body>
        ...
        <table width="100%">
            <tr>
                ...
                <td width="10%" align="right" style="vertical-align:middle;">
                    <!-- Optional: Right Logo if available -->
                </td>
            </tr>
        </table>
    </div>

    <h3 style="text-align:center; margin:0 0 20px 0; text-decoration:underline;">ASESMEN AWAL MEDIS PENYAKIT DALAM</h3>
    ...
    <table width="100%" cellpadding="3">
        <tr>
            <td width="20%"><b>Kondisi:</b> <?= $asesment['kondisi'] ?></td>
            <td width="20%"><b>Status:</b> <?= $asesment['status'] ?></td>
            <td width="15%"><b>GCS:</b> <?= $asesment['gcs'] ?></td>
            <td width="15%"><b>Kesadaran:</b> <?= $asesment['kesadaran'] ?? '-' ?></td>
        </tr>
        <tr>
    ...
    <div class="box">
        ...
        <ul>
            <li><b>Kepala:</b> <?= $asesment['kepala'] ?>
                <?= $asesment['keterangan_kepala'] ? '(' . $asesment['keterangan_kepala'] . ')' : '' ?>
            </li>
            <li><b>Thoraks:</b> <?= $asesment['thoraks'] ?>
                <?= $asesment['keterangan_thorak'] ? '(' . $asesment['keterangan_thorak'] . ')' : '' ?>
            </li>
            <li><b>Abdomen:</b> <?= $asesment['abdomen'] ?>
                <?= $asesment['keterangan_abdomen'] ? '(' . $asesment['keterangan_abdomen'] . ')' : '' ?>
            </li>
            <li><b>Ekstremitas:</b> <?= $asesment['ekstremitas'] ?>
                <?= $asesment['keterangan_ekstremitas'] ? '(' . $asesment['keterangan_ekstremitas'] . ')' : '' ?>
            </li>
        </ul>
        <?php if ($asesment['lainnya']): ?>
            <p><b>Lainnya:</b> <?= $asesment['lainnya'] ?></p>
        <?php endif; ?>
    </div>
    ...
    <div class="section-title">IV. DIAGNOSIS & PERENCANAAN</div>
    <table class="table-data">
        <tr>
