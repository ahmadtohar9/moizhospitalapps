...
<head>
    <title>Asesmen Awal Medis KULIT</title>
    <style>
        body {
...
<body>
    ...
    <h3 style="text-align:center; margin:0 0 20px 0; text-decoration:underline;">ASESMEN AWAL MEDIS KULIT & KELAMIN</h3>
    ...
    <div class="section-title">III. STATUS LOKALIS & DERMATOLOGIS</div>
    <?php if (!empty($asesment['statusderma'])): ?>
        <p><b>Status Dermatologis:</b><br><?= nl2br($asesment['statusderma']) ?></p>
    <?php endif; ?>
    ...
    <p><?= nl2br($asesment['pemeriksaan']) ?: '-' ?></p>
